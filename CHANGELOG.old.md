...
- 📚 Start to add deprecations in anticipation of v5. We plan to add a deprecation for any breaking change in v5 that allows it. Each warning comes with a simple message that explains how to handle the deprecation. If no warnings are reported in the console, you are set for this first batch.
  Please report issues with the deprecations on [#22074](https://github.com/mui/mui/issues/22074) (wrong instructions, false-positives, floods in the console, etc.).
...
You can follow our progress on the [v5 milestone](https://github.com/mui/mui/milestone/35). We will make the documentation of the v5 alpha releases available under https://next.mui.com/, starting next week (weekly releases, as usual).
...
In the coming weeks, we will initiate our work on the [next major: v5](https://github.com/mui/mui/issues/20012).
...
- At least 6 months of work on v5 to get to a stable release (probably more). You can follow our [milestone](https://github.com/mui/mui/milestone/35). We will look for hiring a new full-time member on the core team to move faster.
...
This release fixes an important regression with TypeScript: https://github.com/mui/mui/issues/15076.
...
- You can track our progress following this URL: https://github.com/mui/mui/milestone/25.
...
The next major release is planned for [Q1, 2019](https://github.com/mui/mui/milestone/25).
...
We provide a codemod to automate the migration: https://github.com/mui/mui/tree/master/packages/material-ui-codemod#import-path. I have used it to upgrade all the demos in the documentation :).
...
I have made a mistake in [#8108](https://github.com/mui/mui/pull/8108). The property isn't applied on a `FormControl` but on a `FormLabel` component.
...
- New [Frequently asked questions](https://github.com/mui/mui/blob/4df547d56448cedf70977d6e2463b38eaf64d1c7/docs/src/pages/getting-started/frequently-asked-questions.md) documentation section
...
Visual regression tests are now sent to [argos-ci](https://www.argos-ci.com/mui/mui).
...
- We went from 12k to 22k [stars](http://www.timqian.com/star-history/#mui/mui). :star:

That wouldn't have been possible without this awesome community.
**Thank you!**

But this's just the beginning, some [exciting stuff](https://github.com/mui/mui/blob/next/ROADMAP.md) is coming in 2017 :sparkles:.
...
This release is intended to solve an [issue](https://github.com/mui/mui/issues/5573) with `react-tap-event-plugin` following the release of React `v15.4.0`.
...
For more details, you can have a look a the [next milestone](https://github.com/mui/mui/milestone/14) as well as the [next project](https://github.com/mui/mui/projects/1)
...
[readme](https://github.com/mui/mui/tree/master/packages/material-ui-codemod/README.md).
...
[great efforts](https://github.com/mui/mui/pulls?utf8=%E2%9C%93&q=is%3Apr+is%3Aclosed+author%3Anewoga+style-propable)
of @newoga :+1:
...
- Refactored all CSS into Javascript (#30, #316)
  - All Material-UI components now have their styles defined inline. This solves
    ...
    [Read our CSS in JS discussion](https://github.com/mui/mui/issues/30)
  - Upgrade path:
    - _If you are overriding component CSS classes:_ Redefine your overrides as
      ...
      that you are trying to override, [submit an issue](https://github.com/mui/mui/issues/new)
      requesting to have it added.
    - _If you are using any of Material-UI's Less files:_ These files have been
      refactored into their [own javascript files](https://github.com/mui/mui/tree/css-in-js/src/styles)
...
- Removed Icon component - Replaced with FontIcon and SvgIcon (#318, #125, #148)
  ...
  - Upgrade path:
    - If you were using the Icon component before, you'll need switch to either using FontIcon or SvgIcon.
      ...
      can be found [here](https://github.com/mui/mui/tree/master/src/js/svg-icons).
