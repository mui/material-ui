...
describe('Luxon utils', () => {
  ...
  it('Should format correctly', () => {
    ...
    // TODO: fix when this is fixed: https://github.com/moment/luxon/issues/204#issuecomment-379902233
    // expect(luxonUtilDe.format(now, 'yyyy LLL dd')).toBe('2018 Mär 01');
  });
  ...
  it('Should get the weekdays', () => {
    expect(luxonUtil.getWeekDays()).toEqual(['M', 'T', 'W', 'T', 'F', 'S', 'S']);
    // TODO: fix when this is fixed: https://github.com/moment/luxon/issues/204#issuecomment-379902233
    // expect(luxonUtilDe.getWeekDays()).toEqual(['M', 'D', 'M', 'D', 'F', 'S', 'S']);
  });
  ...
  it('Should get the meridiem text', () => {
    ...
    // TODO: fix when this is fixed: https://github.com/moment/luxon/issues/204#issuecomment-379902233
    // expect(luxonUtilDe.getMeridiemText('am')).toBe('vorm.');
    // expect(luxonUtilDe.getMeridiemText('pm')).toBe('nachm.');
  });
  ...
  it('Should get the calendar header text', () => {
    ...
    // TODO: fix when this is fixed: https://github.com/moment/luxon/issues/204#issuecomment-379902233
    // expect(luxonUtilDe.getCalendarHeaderText(now)).toBe('Januar 2018');
  });
  ...
  it('Should get the date picker header text', () => {
    ...
    // TODO: fix when this is fixed: https://github.com/moment/luxon/issues/204#issuecomment-379902233
    // expect(luxonUtilDe.getDatePickerHeaderText(now)).toBe('Di, März 1');
  });
  ...
  it('Should get the date time picker header text', () => {
    ...
    // TODO: fix when this is fixed: https://github.com/moment/luxon/issues/204#issuecomment-379902233
    // expect(luxonUtilDe.getDateTimePickerHeaderText(now)).toBe('Mär 1');
  });
