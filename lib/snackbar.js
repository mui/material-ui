...
var NavigationClose = require('./svg-icons/navigation/close');
...
var Snackbar = React.createClass({
  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement('span', { style: { order: 2, borderRight: '1px solid rgba(0, 0, 0, 0.26)', marginLeft: '20px', marginTop: '10px', marginBottom: '10px' } }),
      action,
      React.createElement(
        IconButton,
        { style: { order: 4 }, onTouchTap: this.dismiss() },
