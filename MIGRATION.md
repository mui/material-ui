...
- [x] 2.1 `definitions/properties.ts` — `git commit -m "[docs-infra] Migrate properties definitions to @mui/docs (2.1)"`
- [x] 2.2 `definitions/classes.ts` — `git commit -m "[docs-infra] Migrate classes definitions to @mui/docs (2.2)"`
- [x] 2.3 `definitions/slots.ts` — `git commit -m "[docs-infra] Migrate slots definitions to @mui/docs (2.3)"`
