...
description: Integrates Material UI with Next.js App and Pages routers using @mui/material-nextjs, Emotion cache providers, next/font, CSS layers with Tailwind/CSS Modules, Link component prop patterns, and CSS theme variables SSR notes. Use when setting up or debugging MUI in a Next.js app.
license: MIT
metadata:
  author: mui
  version: "1.0.0"
...
Agent skill for **Next.js + Material UI** wiring (SSR/streaming, cache providers, fonts, layers, Link). **SKILL.md** is the entry; **AGENTS.md** is the full guide.
...
| Area | Topics |
|------|--------|
| App Router | `AppRouterCacheProvider`, `@emotion/cache`, `options` |
