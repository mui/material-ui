...
@styled-system/css x 68,411 ops/sec ±0.63% (189 runs sampled)
@chakra-ui/system/css x 234,332 ops/sec ±1.00% (192 runs sampled)
@material-ui/system styleFunctionSx x 41,202 ops/sec ±0.68% (191 runs sampled)
```
