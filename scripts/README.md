...
4. `yarn release:version`, keep in mind:
   ...
   4. [IMPORTANT] Search for the older version string in the whole project directory and bump packages and it's references that are still on the old version.
