          ...
          emotionStyleTags: styles.map((style) => {
            ...
            return (
              <style
                ...
                key={style.key}
                // eslint-disable-next-line react/no-danger -- comes from `extractCriticalToChunks`, which carries `sx`/theme/`GlobalStyles` values that Emotion serializes without escaping HTML
