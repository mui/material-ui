...
describe('<CircularProgress />', () => {
  ...
  it('should contain an SVG with the svg class, and a circle with the circle class', () => {
    ...
    expect(svg.firstChild).to.have.class(classes.circle);
  });
  ...
  it('should render indeterminate variant by default', () => {
    ...
    const svg = circularProgress.firstChild!;
    expect(svg.firstChild).to.have.class(classes.circleIndeterminate);
  });
  ...
  describe('prop: variant="determinate"', () => {
    ...
    it('should set strokeDasharray of circle', () => {
      ...
      const svg = circularProgress.firstChild!;
      const circle = svg.firstChild!;
      expect(circle).to.have.property('strokeDasharray', '126.920px', 'should have strokeDasharray set')
      expect(circle).to.have.property('strokeDashoffset', '38.076px', 'should have strokeDashoffset set')
