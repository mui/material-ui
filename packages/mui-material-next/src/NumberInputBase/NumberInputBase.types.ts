...
import { UseNumberInputRootSlotProps } from '@mui/base/unstable_useNumberInput';
import { SxProps } from '@mui/system';
import { OverridableStringUnion, OverrideProps, Simplify } from '@mui/types';
import { Theme } from '../styles';
import { NumberInputBaseClasses } from './numberInputBaseClasses';

export interface NumberInputBasePropsSizeOverrides {}
export interface NumberInputBasePropsColorOverrides {}
...
export type NumberInputBaseOwnProps = {
   ...
   */
  classes?: Partial<NumberInputBaseClasses>;
  /**
  ...
  color?: OverridableStringUnion<
    ...
    NumberInputBasePropsColorOverrides
  >;
  /**
   ...
   */
  size?: OverridableStringUnion<'small' | 'medium', NumberInputBasePropsSizeOverrides>;
  /**
  ...
  slotProps?: {
    root?: SlotComponentProps<
      'div',
      NumberInputBaseRootSlotPropsOverrides,
...
export interface NumberInputBaseTypeMap<
  AdditionalProps = {},
  RootComponentType extends React.ElementType = 'div',
> {
  props: NumberInputBaseOwnProps & AdditionalProps;
  defaultComponent: RootComponentType;
}

export type NumberInputBaseProps<
  RootComponentType extends React.ElementType = NumberInputBaseTypeMap['defaultComponent'],
  AdditionalProps = {},
> = OverrideProps<NumberInputBaseTypeMap<AdditionalProps, RootComponentType>, RootComponentType> & {
  inputComponent?: React.ElementType;
};

export type NumberInputBaseOwnerState = Simplify<
...
export type NumberInputBaseRootSlotProps = Simplify<
  UseNumberInputRootSlotProps & {
    ownerState: NumberInputBaseOwnerState;
    className?: string;
...
export type NumberInputBaseInputSlotProps = Simplify<
