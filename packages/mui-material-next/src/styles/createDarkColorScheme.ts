...
const createDarkColorScheme = (
  ...
  surfaceDim: getCssVar('ref-palette-neutral-6', palette.neutral[6]),
  surface: getCssVar('ref-palette-neutral-6', palette.neutral[6]),
  surfaceBright: getCssVar('ref-palette-neutral-24', palette.neutral[24]),
  surfaceContainerLowest: getCssVar('ref-palette-neutral-4', palette.neutral[4]),
  surfaceContainerLow: getCssVar('ref-palette-neutral-10', palette.neutral[10]),
  surfaceContainer: getCssVar('ref-palette-neutral-12', palette.neutral[12]),
  ...
  primaryFixed: getCssVar('ref-palette-primary-90', palette.primary[90]),
  primaryFixedDim: getCssVar('ref-palette-primary-80', palette.primary[80]),
  onPrimaryFixed: getCssVar('ref-palette-primary-10', palette.primary[10]),
  onPrimaryFixedVariant: getCssVar('ref-palette-primary-30', palette.primary[30]),
  secondaryFixed: getCssVar('ref-palette-secondary-90', palette.secondary[90]),
  secondaryFixedDim: getCssVar('ref-palette-secondary-80', palette.secondary[80]),
  onSecondaryFixed: getCssVar('ref-palette-secondary-10', palette.secondary[10]),
  onSecondaryFixedVariant: getCssVar('ref-palette-secondary-30', palette.secondary[30]),
  tertiaryFixed: getCssVar('ref-palette-tertiary-90', palette.tertiary[90]),
  tertiaryFixedDim: getCssVar('ref-palette-tertiary-80', palette.tertiary[80]),
  onTertiaryFixed: getCssVar('ref-palette-tertiary-10', palette.tertiary[10]),
  onTertiaryFixedVariant: getCssVar('ref-palette-tertiary-30', palette.tertiary[30]),
});
