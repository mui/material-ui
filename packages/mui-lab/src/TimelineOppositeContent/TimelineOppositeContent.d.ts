...
import type { InternalStandardProps as StandardProps, TypographyProps } from '@mui/material';
import type { TimelineOppositeContentClasses } from './timelineOppositeContentClasses';
