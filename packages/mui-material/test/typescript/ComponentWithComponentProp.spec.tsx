...
import {
  ...
  PropsWithComponentProp,
} from '@mui/material/ComponentWithComponentProp';
...
declare const Foo: ComponentWithComponentProp<
  {
    numberProp: number;
...
<Foo
  ...
  myString="hello"
  numberProp={3}
  className="TODO - needed to add this"
/>;
...
declare const Bar: ComponentWithComponentProp<
  {
    numberProp: number;
    callbackProp?(b: boolean): void;
  },
...
type BarProps<D extends React.ElementType = 'span', P = {}> = PropsWithComponentProp<
  P & {
    numberProp: number;
    callbackProp?(b: boolean): void;
  },
