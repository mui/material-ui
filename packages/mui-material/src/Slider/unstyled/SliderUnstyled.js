...
// NOTE: RtlProvider and DefaultPropsProvider are plain React contexts with no
// styling dependency, but they live in `@mui/system` today. A real package split
// would need to re-home them alongside the unstyled layer.
...
const slotDefs = sliderSlots.slots;
...
const Slider = React.forwardRef(function Slider(inProps, ref) {
  ...
  const [RootSlot, rootProps] = useSlot('root', {
    elementType: slotDefs.root.elementType,
  ...
  const [RailSlot, railProps] = useSlot('rail', {
    elementType: slotDefs.rail.elementType,
    externalForwardedProps,
    ownerState,
  ...
  const [TrackSlot, trackProps] = useSlot('track', {
    elementType: slotDefs.track.elementType,
    externalForwardedProps,
    additionalProps: {
      style: {
  ...
  const [ThumbSlot, thumbProps] = useSlot('thumb', {
    elementType: slotDefs.thumb.elementType,
  ...
  const [ValueLabelSlot, valueLabelProps] = useSlot('valueLabel', {
    elementType: slotDefs.valueLabel.elementType,
    externalForwardedProps,
    ownerState,
  ...
  const [MarkSlot, markProps] = useSlot('mark', {
    elementType: slotDefs.mark.elementType,
    externalForwardedProps,
    ownerState,
  ...
  const [MarkLabelSlot, markLabelProps] = useSlot('markLabel', {
    elementType: slotDefs.markLabel.elementType,
    externalForwardedProps,
    ownerState,
  ...
  const [InputSliderSlot, inputSliderProps] = useSlot('input', {
    elementType: slotDefs.input.elementType,
