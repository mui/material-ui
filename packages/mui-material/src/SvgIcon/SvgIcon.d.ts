 ...
 * Demos:
 *
 * - [Icons](https://mui.com/material/components/icons/)
 * - [Material Icons](https://mui.com/material/components/material-icons/)
 *
 * API:
 *
 * - [SvgIcon API](https://mui.com/material/api/svg-icon/)
 */
