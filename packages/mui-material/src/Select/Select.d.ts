...
export interface BaseSelectProps<Value = unknown>
  ...
  /**
   * See [OutlinedInput#label](https://next.mui.com/material-ui/api/outlined-input/#props)
   */
  ...
  labelId?: string;
  /**
   * Props applied to the [`Menu`](https://next.mui.com/material-ui/api/menu/) element.
   */
