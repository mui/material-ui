 ...
 * Demos:
 *
 * - [Selects](https://mui.com/material/components/selects/)
 *
 * API:
 *
 * - [Select API](https://mui.com/material/api/select/)
 * - inherits [OutlinedInput API](https://mui.com/material/api/outlined-input/)
 */
