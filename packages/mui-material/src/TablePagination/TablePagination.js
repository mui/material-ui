...
TablePagination.propTypes /* remove-proptypes */ = {
  ...
  /**
   * Props applied to the back arrow [`IconButton`](https://next.mui.com/material-ui/api/icon-button/) component.
   *
  ...
  /**
   * Props applied to the next arrow [`IconButton`](https://next.mui.com/material-ui/api/icon-button/) element.
   *
  ...
  /**
   * Props applied to the rows per page [`Select`](https://next.mui.com/material-ui/api/select/) element.
   *
