...
export { default as createVariableIconFromString } from './createVariableIconFromString';
export { default as createVariableIconFromSvg } from './createVariableIconFromSvg';
