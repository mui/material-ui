...
export default function extendTheme(options = {}, ...args) {
  ...
  Object.keys(theme.colorSchemes).forEach((key) => {
    ...
    if (key === 'light') {
      setColor(palette.AppBar, 'defaultBgColor', 'var(--mui-palette-grey-100)');
      setColor(palette.Chip, 'defaultBorderColor', 'var(--mui-palette-grey-400)');
      ...
      setColor(palette.Skeleton, 'bgColor', 'rgba(var(--mui-palette-text-primary) / 0.11)');
      ...
      setColor(palette.StepConnector, 'borderColor', 'var(--mui-palette-grey-400)');
      setColor(palette.StepContent, 'borderColor', 'var(--mui-palette-grey-400)');
      ...
      setColor(palette.AppBar, 'defaultBgColor', 'var(--mui-palette-grey-900)');
      setColor(palette.Chip, 'defaultBorderColor', 'var(--mui-palette-grey-700)');
      ...
      setColor(palette.Skeleton, 'bgColor', 'rgba(var(--mui-palette-text-primary) / 0.13)');
      ...
      setColor(palette.AppBar, 'defaultBgColor', 'var(--mui-palette-grey-900)');
      setColor(palette.StepConnector, 'borderColor', 'var(--mui-palette-grey-600)');
      setColor(palette.StepContent, 'borderColor', 'var(--mui-palette-grey-600)');
