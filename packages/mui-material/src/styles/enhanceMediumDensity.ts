...
export default function enhanceMediumDensity<T extends EnhanceableTheme>(theme: T) {
  ...
  addRootOverride(enhanced.components, 'MuiMenuItem', {
    ...
    variants: [
      { props: { dense: false }, style: { minHeight: '44px', paddingBlock: d['x-small'] } },
      { props: { dense: true }, style: { minHeight: '32px', paddingBlock: d['xx-small'] } },
      ...
      variants: [
        {
          ...
          style: { minWidth: '20px', height: '20px', paddingInline: d['x-small'] },
        },
  ...
  addRootOverride(
    enhanced.components,
    'MuiDataGrid',
    { minHeight: '52px', padding: d.small, gap: d['xx-small'] },
    'toolbar',
  );
  addRootOverride(
    enhanced.components,
  ...
  addRootOverride(
    enhanced.components,
    'MuiDataGrid',
    { flexBasis: '28px', marginRight: d.large },
  ...
  addRootOverride(
    enhanced.components,
    'MuiDataGrid',
    { height: '32px', marginInlineStart: d['x-small'] },
    'pivotPanelField',
  );
  addRootOverride(
    enhanced.components,
