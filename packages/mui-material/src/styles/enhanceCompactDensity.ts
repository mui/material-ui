...
export default function enhanceCompactDensity<T extends EnhanceableTheme>(theme: T) {
  ...
  addRootOverride(enhanced.components, 'MuiMenuItem', {
    ...
    variants: [
      { props: { dense: false }, style: { minHeight: '36px', paddingTop: d.xs, paddingBottom: d.xs } },
      { props: { dense: true }, style: { minHeight: '28px', paddingTop: d.xxs, paddingBottom: d.xxs } },
    ...
    variants: [
      {
        ...
        style: {
          [`.${inputLabelClasses.root}:has(~ &)`]: {
            '--FilledInputLabel-restY': '8px',
            '--FilledInputLabel-shrinkY': '3px',
          },
        },
      },
      {
  ...
  addRootOverride(enhanced.components, 'MuiChip', {
    variants: [
      { props: { size: 'medium' }, style: { '--Chip-height': '28px' } },
      { props: { size: 'small' }, style: { '--Chip-height': '20px' } },
    ],
  });
