import { type ThemeOptions, type Theme } from './createThemeNoVars';
import { type Components } from './components';
import {
  type DefaultColorScheme,
  type ColorSchemeOverrides,
  type ExtendedColorScheme,
  type SupportedColorScheme,
  type Opacity,
  type Overlays,
  type PaletteBackgroundChannel,
  type PaletteCommonChannel,
  type PaletteColorChannel,
  type PaletteActionChannel,
  type PaletteTextChannel,
  type PaletteAlert,
  type PaletteAppBar,
  type PaletteAvatar,
  type PaletteButton,
  type PaletteChip,
  type PaletteFilledInput,
  type PaletteLinearProgress,
  type PaletteSkeleton,
  type PaletteSlider,
  type PaletteSnackbarContent,
  type PaletteSpeedDialAction,
  type PaletteStepConnector,
  type PaletteStepContent,
  type PaletteSwitch,
  type PaletteTableCell,
  type PaletteTooltip,
  type ColorSystemOptions,
  type CssVarsPalette,
  type ColorSystem,
  type ThemeVars,
  type ThemeCssVarOverrides,
  type ThemeCssVar,
  type CssVarsTheme,
  type Shape,
  type ShapeOptions,
