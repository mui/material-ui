...
import { MenuPreviewProps } from '../MenuPreview';
import { MenuPreviewCheckboxItemProps } from '../MenuPreviewCheckboxItem';
import { MenuPreviewCheckboxItemIndicatorProps } from '../MenuPreviewCheckboxItemIndicator';
import { MenuPreviewGroupProps } from '../MenuPreviewGroup';
import { MenuPreviewGroupLabelProps } from '../MenuPreviewGroupLabel';
import { MenuPreviewItemProps } from '../MenuPreviewItem';
import { MenuPreviewLinkItemProps } from '../MenuPreviewLinkItem';
import { MenuPreviewPopupProps } from '../MenuPreviewPopup';
import { MenuPreviewRadioGroupProps } from '../MenuPreviewRadioGroup';
import { MenuPreviewRadioItemProps } from '../MenuPreviewRadioItem';
import { MenuPreviewRadioItemIndicatorProps } from '../MenuPreviewRadioItemIndicator';
import { MenuPreviewSeparatorProps } from '../MenuPreviewSeparator';
import { MenuPreviewSubmenuPopupProps } from '../MenuPreviewSubmenuPopup';
import { MenuPreviewSubmenuRootProps } from '../MenuPreviewSubmenuRoot';
import { MenuPreviewSubmenuTriggerProps } from '../MenuPreviewSubmenuTrigger';
import { MenuPreviewTriggerProps } from '../MenuPreviewTrigger';
...
export interface ComponentsPropsList {
  ...
  MuiMenuPreview: MenuPreviewProps;
  MuiMenuPreviewCheckboxItem: MenuPreviewCheckboxItemProps;
  MuiMenuPreviewCheckboxItemIndicator: MenuPreviewCheckboxItemIndicatorProps;
  MuiMenuPreviewGroup: MenuPreviewGroupProps;
  MuiMenuPreviewGroupLabel: MenuPreviewGroupLabelProps;
  MuiMenuPreviewItem: MenuPreviewItemProps;
  MuiMenuPreviewLinkItem: MenuPreviewLinkItemProps;
  MuiMenuPreviewPopup: MenuPreviewPopupProps;
  MuiMenuPreviewRadioGroup: MenuPreviewRadioGroupProps;
  MuiMenuPreviewRadioItem: MenuPreviewRadioItemProps;
  MuiMenuPreviewRadioItemIndicator: MenuPreviewRadioItemIndicatorProps;
  MuiMenuPreviewSeparator: MenuPreviewSeparatorProps;
  MuiMenuPreviewSubmenuPopup: MenuPreviewSubmenuPopupProps;
  MuiMenuPreviewSubmenuRoot: MenuPreviewSubmenuRootProps;
  MuiMenuPreviewSubmenuTrigger: MenuPreviewSubmenuTriggerProps;
  MuiMenuPreviewTrigger: MenuPreviewTriggerProps;
