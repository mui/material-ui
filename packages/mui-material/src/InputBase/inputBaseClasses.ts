...
export interface InputBaseClasses {
  ...
  /** Styles applied to the input element when type is date, time, datetime-local, month, or week. Fixes shrunken height on iOS Safari (see https://bugs.webkit.org/show_bug.cgi?id=198959). */
