...
export interface MenuPreviewItemVisualProps<
  Classes,
  Slots = MenuPreviewRootSlots,
  SlotProps = MenuPreviewRootSlotProps<MenuPreviewItemOwnerState>,
> {
  /**
