...
export interface MenuPreviewProps<Payload = unknown> extends BaseMenu.Root.Props<Payload> {
  /**
   ...
   */
  onOpenChange?: BaseMenu.Root.Props<Payload>['onOpenChange'];
  /**
 ...
 */
function MenuPreview<Payload = unknown>(props: MenuPreviewProps<Payload>): React.JSX.Element {
