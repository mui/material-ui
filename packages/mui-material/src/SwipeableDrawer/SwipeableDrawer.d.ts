 ...
 * Demos:
 *
 * - [Drawers](https://mui.com/material/components/drawers/)
 *
 * API:
 *
 * - [SwipeableDrawer API](https://mui.com/material/api/swipeable-drawer/)
 * - inherits [Drawer API](https://mui.com/material/api/drawer/)
 */
