  ...
  function applySizeVars(size: ListProps['size']) {
    if (size === 'sm') {
      return {
        ...
        '--ListItem-fontSize': theme.vars.fontSize.xs,
        '--ListItem-lineHeight': theme.vars.lineHeight.xl,
    ...
    if (size === 'md') {
      return {
        ...
        '--ListItem-lineHeight': theme.vars.lineHeight.sm,
    ...
    if (size === 'lg') {
      return {
        ...
        '--ListItem-lineHeight': theme.vars.lineHeight.md,
