...
const InputRoot = styled('div', {
...
})<{ ownerState: InputProps & InputUnstyledOwnerState }>(({ theme, ownerState }) => [
  {
    ...
    '--Input-decorator-childOffset':
      'min(calc(var(--Input-paddingInline) - var(--Input-decorator-offset) - (var(--Input-minHeight) - 2 * var(--variant-borderWidth, 0px) - var(--Input-decorator-childHeight)) / 2), var(--Input-paddingInline) - var(--Input-decorator-offset))',
    ...
    '--Input-decorator-childRadius':
      'max((var(--Input-radius) - var(--variant-borderWidth, 0px)) - var(--internal-paddingBlock), min(var(--internal-paddingBlock) / 2, (var(--Input-radius) - var(--variant-borderWidth, 0px)) / 2))',
