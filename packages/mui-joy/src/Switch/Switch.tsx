...
const SwitchRoot = styled('div', {
  ...
  return {
    ...
    '--unstable_Switch-paddingBlock': `max((var(--Switch-track-height) - 2 * var(--variant-borderWidth) - var(--Switch-thumb-size)) / 2, 0px)`,
    '--Switch-thumb-radius': `max((var(--Switch-track-radius) - var(--variant-borderWidth)) - var(--unstable_Switch-paddingBlock), min(var(--unstable_Switch-paddingBlock) / 2, (var(--Switch-track-radius) - var(--variant-borderWidth)) / 2))`,
