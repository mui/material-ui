...
const createLightModeVariantVariables = (color: ColorPaletteProp) => ({
  ...
  plainDisabledColor: `var(--joy-palette-${color}-300)`,
  ...
  outlinedDisabledColor: `var(--joy-palette-${color}-300)`,
  ...
  solidDisabledColor: `var(--joy-palette-${color}-300)`,
...
const createDarkModeVariantVariables = (color: ColorPaletteProp) => ({
  ...
  softDisabledColor: `var(--joy-palette-${color}-700)`,
