    ...
    it('palette', () => {
      ...
      expect(screen.getByTestId('palette-primary').textContent).to.equal(
        JSON.stringify({
          ...
          filledColor: 'var(--joy-palette-primary-filledColor)',
          filledBg: 'var(--joy-palette-primary-filledBg)',
          filledHoverBg: 'var(--joy-palette-primary-filledHoverBg)',
          filledActiveBg: 'var(--joy-palette-primary-filledActiveBg)',
          filledDisabledColor: 'var(--joy-palette-primary-filledDisabledColor)',
          filledDisabledBg: 'var(--joy-palette-primary-filledDisabledBg)',
      ...
      expect(screen.getByTestId('palette-danger').textContent).to.equal(
        JSON.stringify({
          ...
          filledColor: 'var(--joy-palette-danger-filledColor)',
          filledBg: 'var(--joy-palette-danger-filledBg)',
          filledHoverBg: 'var(--joy-palette-danger-filledHoverBg)',
          filledActiveBg: 'var(--joy-palette-danger-filledActiveBg)',
          filledDisabledColor: 'var(--joy-palette-danger-filledDisabledColor)',
          filledDisabledBg: 'var(--joy-palette-danger-filledDisabledBg)',
      ...
      expect(screen.getByTestId('palette-info').textContent).to.equal(
        JSON.stringify({
          ...
          filledColor: 'var(--joy-palette-info-filledColor)',
          filledBg: 'var(--joy-palette-info-filledBg)',
          filledHoverBg: 'var(--joy-palette-info-filledHoverBg)',
          filledActiveBg: 'var(--joy-palette-info-filledActiveBg)',
          filledDisabledColor: 'var(--joy-palette-info-filledDisabledColor)',
          filledDisabledBg: 'var(--joy-palette-info-filledDisabledBg)',
      ...
      expect(screen.getByTestId('palette-success').textContent).to.equal(
        JSON.stringify({
          ...
          filledColor: 'var(--joy-palette-success-filledColor)',
          filledBg: 'var(--joy-palette-success-filledBg)',
          filledHoverBg: 'var(--joy-palette-success-filledHoverBg)',
          filledActiveBg: 'var(--joy-palette-success-filledActiveBg)',
          filledDisabledColor: 'var(--joy-palette-success-filledDisabledColor)',
          filledDisabledBg: 'var(--joy-palette-success-filledDisabledBg)',
      ...
      expect(screen.getByTestId('palette-warning').textContent).to.equal(
        JSON.stringify({
          ...
          filledColor: 'var(--joy-palette-warning-filledColor)',
          filledBg: 'var(--joy-palette-warning-filledBg)',
          filledHoverBg: 'var(--joy-palette-warning-filledHoverBg)',
          filledActiveBg: 'var(--joy-palette-warning-filledActiveBg)',
          filledDisabledColor: 'var(--joy-palette-warning-filledDisabledColor)',
          filledDisabledBg: 'var(--joy-palette-warning-filledDisabledBg)',
