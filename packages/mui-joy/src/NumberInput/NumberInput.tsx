...
export const StyledNumberInputHtml = styled('input')<{ ownerState: NumberInputOwnerState }>(
  ({ ownerState }) => ({
...
export const StyledNumberInputStartDecorator = styled('div')<{ ownerState: NumberInputOwnerState }>(
  {
...
export const StyledNumberInputEndDecorator = styled('div')<{ ownerState: NumberInputOwnerState }>({
...
const NumberInput = React.forwardRef(function Input(inProps, ref) {
  ...
  const {
    ...
    slotProps = {},
    ...other
  } = useForwardedInput<NumberInputProps>(props, inputClasses);
