...
const sfcElem = <DecoratedSFC text="Hello, World!" variant="headline6" color="secondary" />;
const classElem = <DecoratedClass text="Hello, World!" variant="headline6" color="secondary" />;
