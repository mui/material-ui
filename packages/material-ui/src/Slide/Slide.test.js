...
describe('<Slide />', () => {
  ...
  describe('transform styling', () => {
    ...
    describe('handleEnter()', () => {
      ...
      it('should set element transform and transition in the `left` direction', () => {
        ...
        wrapper.setProps({ in: true });
        assert.strictEqual(nodeEnterTransformStyle, `translateX(${global.innerWidth}px) translateX(-300px)`);
      });
      ...
      it('should set element transform and transition in the `up` direction', () => {
        ...
        wrapper.setProps({ in: true });
        assert.strictEqual(nodeEnterTransformStyle, `translateY(${global.innerHeight}px) translateY(-200px)`);
      });
    ...
    describe('handleExiting()', () => {
      ...
      it('should set element transform and transition in the `left` direction', () => {
        wrapper.setProps({ direction: 'left' });
        wrapper.setProps({ in: false });
        assert.strictEqual(nodeExitingTransformStyle, `translateX(${global.innerWidth}px) translateX(-300px)`);
      });
      ...
      it('should set element transform and transition in the `up` direction', () => {
        wrapper.setProps({ direction: 'up' });
        wrapper.setProps({ in: false });
        assert.strictEqual(nodeExitingTransformStyle, `translateY(${global.innerHeight}px) translateY(-200px)`);
      });
  ...
  describe('resize', () => {
    ...
    it('should take existing transform into account', () => {
      ...
      assert.strictEqual(element.style.transform, `translateY(${global.innerHeight}px) translateY(-780px)`);
    });
