...
describe('<Slide />', () => {
  ...
  describe('transform styling', () => {
    ...
    describe('handleEnter()', () => {
      ...
      it('should set element transform and transition in the `left` direction', () => {
        ...
        wrapper.setProps({ in: true });
        assert.strictEqual(nodeEnterTransformStyle, 'translateX(1024px) translateX(-300px)');
      });
      ...
      it('should set element transform and transition in the `up` direction', () => {
        ...
        wrapper.setProps({ in: true });
        assert.strictEqual(nodeEnterTransformStyle, 'translateY(768px) translateY(-200px)');
      });
    ...
    describe('handleExiting()', () => {
      ...
      it('should set element transform and transition in the `left` direction', () => {
        wrapper.setProps({ direction: 'left' });
        wrapper.setProps({ in: false });
        assert.strictEqual(nodeExitingTransformStyle, 'translateX(1024px) translateX(-300px)');
      });
      ...
      it('should set element transform and transition in the `up` direction', () => {
        wrapper.setProps({ direction: 'up' });
        wrapper.setProps({ in: false });
        assert.strictEqual(nodeExitingTransformStyle, 'translateY(768px) translateY(-200px)');
      });
  ...
  describe('resize', () => {
    ...
    it('should take existing transform into account', () => {
      ...
      assert.strictEqual(element.style.transform, 'translateY(768px) translateY(-780px)');
    });
