...
describe('transitions', () => {
  ...
  describe('create() function', () => {
    it('should create default transition without arguments', () => {
      ...
      assert.strictEqual(consoleWarnStub.callCount, 0, 'Wrong number of calls of warning()');
    });
    ...
    it('should warn when first argument is of bad type', () => {
      ...
      // $FlowIgnore
      transitions.create({});
      assert.strictEqual(consoleWarnStub.callCount, 2, 'Wrong number of calls of warning()');
    });
    ...
    it('should warn when passed unrecognized option', () => {
      ...
      assert.strictEqual(consoleWarnStub.callCount, 1, 'Wrong number of calls of warning()');
    });
