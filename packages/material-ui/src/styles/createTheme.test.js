...
describe('createTheme', () => {
  ...
  it('should allow providing a partial structure', () => {
    const muiTheme = createTheme({ transitions: { duration: { shortest: 150 } } });
  ...
  describe('shadows', () => {
    ...
    it('should override the array as expected', () => {
      ...
      const muiTheme = createTheme({ shadows });
  ...
  describe('props', () => {
    it('should have the props as expected', () => {
      ...
      const muiTheme = createTheme({ props });
  ...
  describe('overrides', () => {
    ...
    it('should warn when trying to override an internal state the wrong way', () => {
      ...
      theme = createTheme({ overrides: { Button: { disabled: { color: 'blue' } } } });
  ...
  it('shallow merges multiple arguments', () => {
    const muiTheme = createTheme({ foo: 'I am foo' }, { bar: 'I am bar' });
    expect(muiTheme.foo).to.equal('I am foo');
    expect(muiTheme.bar).to.equal('I am bar');
  });

  it('deep merges multiple arguments', () => {
    const muiTheme = createTheme({ custom: { foo: 'I am foo' } }, { custom: { bar: 'I am bar' } });
