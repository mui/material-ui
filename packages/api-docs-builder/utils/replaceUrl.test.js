...
describe('replaceUrl', () => {
  ...
  it('replace correct API links', () => {
    ...
    expect(replaceAPILinks(`/api/button-unstyled/`)).to.equal(`/base/api/button/`);
    ...
    expect(replaceAPILinks(`/api/tab-panel-unstyled/`)).to.equal(`/base/api/tab-panel/`);
    expect(replaceAPILinks(`/api/tabs-list-unstyled/`)).to.equal(`/base/api/tabs-list/`);
    expect(replaceAPILinks(`/api/tabs-unstyled/`)).to.equal(`/base/api/tabs/`);
  ...
  it('should do nothing if the APIs have updated', () => {
    ...
    expect(replaceAPILinks(`/base/api/button/`)).to.equal(`/base/api/button/`);
  ...
  it('only replace links for new routes (/material-ui/* & /x/*)', () => {
    ...
    expect(replaceUrl(`/api/button-unstyled`, '/base/api/button')).to.equal(`/base/api/button`);
  ...
  it('[i18n] only replace links for new routes (/material-ui/* & /x/*)', () => {
    ...
    expect(replaceUrl(`/zh/api/button-unstyled`, '/zh/base/api/button')).to.equal(
      `/zh/base/api/button`,
    );
