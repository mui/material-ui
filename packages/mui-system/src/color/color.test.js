...
describe.only('utils/color', () => {
  describe('parse', () => {
    ...
    it.only('parses CSS color spaces', () => {
      ...
      // FIXME:
      // expect(Color.parse('lab(50% 40 59.5 / 0.5)')).to.equal(0xbf570080)
      // expect(Color.parse('lch(52.2% 72.2 50 / 0.5)')).to.equal(0xcd561a80)

      expect(Color.parse('color(srgb         1 0.5 0 / 0.5)')).to.equal(0xff800080)
      expect(Color.parse('color(srgb-linear  1 0.5 0 / 0.5)')).to.equal(0xffbc0080)
      expect(Color.parse('color(display-p3   1 0.5 0 / 0.5)')).to.equal(0xff760080)
      expect(Color.parse('color(a98-rgb      1 0.5 0 / 0.5)')).to.equal(0xff810080)
      expect(Color.parse('color(prophoto-rgb 1 0.5 0 / 0.5)')).to.equal(0xff630080)
      expect(Color.parse('color(rec2020      1 0.5 0 / 0.5)')).to.equal(0xff720080)
    });
