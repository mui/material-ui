  ...
  function render(markdown) {
    ...
    renderer.heading = (headingHtml, level) => {
      ...
      return [
        ...
        '</a>',
        `<span class="display-none" id="${hash}-comment">for ${headingHtml}</span>`,
        `<button title="Post a comment" aria-describedby="${hash}-comment" class="comment-link" data-feedback-hash="${hash}">`,
