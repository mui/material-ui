  ...
  describe('createRender', () => {
    it('should collect headers correctly', () => {
      ...
      expect(
        ...
        [
          `<h1>Accordion</h1>`,
          `<h2 id="basic-features"><a href="#basic-features" class="title-link-to-anchor">Basic features 🧪<button title="Post a comment" class="comment-link" data-feedback-hash="basic-features"><svg><use xlink:href="#comment-link-icon" /></svg></button></h2>`,
