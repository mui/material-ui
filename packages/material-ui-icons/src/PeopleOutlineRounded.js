...
<g id="Rounded">
	<g>
		...
		<path d="M9,13.75c-2.34,0-7,1.17-7,3.5V18c0,0.55,0.45,1,1,1h12c0.55,0,1-0.45,1-1v-0.75C16,14.92,11.34,13.75,9,13.75z M4.34,17
			c0.84-0.58,2.87-1.25,4.66-1.25s3.82,0.67,4.66,1.25H4.34z" />
		<path d="M16.04,13.81C17.2,14.65,18,15.77,18,17.25V19h3c0.55,0,1-0.45,1-1v-0.75C22,15.23,18.5,14.08,16.04,13.81z" />
