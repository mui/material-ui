...
<g id="Duotone">
	...
	<g>
		<path opacity="0.3" d="M12,4c-4.42,0-8,3.58-8,8c0,4.42,3.58,8,8,8s8-3.58,8-8C20,7.58,16.42,4,12,4z M15.5,8
			...
			S7,10.33,7,9.5S7.67,8,8.5,8z M12,17.5c-2.33,0-4.32-1.45-5.12-3.5h1.67c0.7,1.19,1.97,2,3.45,2s2.75-0.81,3.45-2h1.67
			C16.32,16.05,14.33,17.5,12,17.5z" />
		<circle cx="15.5" cy="9.5" r="1.5" />
		<circle cx="8.5" cy="9.5" r="1.5" />
		<path d="M12,16c-1.48,0-2.75-0.81-3.45-2H6.88c0.8,2.05,2.79,3.5,5.12,3.5s4.32-1.45,5.12-3.5h-1.67C14.75,15.19,13.48,16,12,16z"
			/>
