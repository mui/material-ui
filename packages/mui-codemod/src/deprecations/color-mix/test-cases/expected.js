const ChipRoot = styled('div', {
      ...
      ...(ownerState.onDelete && {
        [`&.${chipClasses.focusVisible}`]: {
          backgroundColor: theme.vars
            ? `color-mix(${theme.vars.palette.action.selected} / calc(${theme.vars.palette.action.selectedOpacity} + ${theme.vars.palette.action.focusOpacity}))`
            : alpha(
  ...
  ({ theme, ownerState }) => ({
    ...(ownerState.clickable && {
      ...
      '&:hover': {
        backgroundColor: theme.vars
          ? `color-mix(${theme.vars.palette.action.selected} / calc(${theme.vars.palette.action.selectedOpacity} + ${theme.vars.palette.action.hoverOpacity}))`
          : alpha(
              theme.palette.action.selected,
  ...
  ({ theme, ownerState }) => ({
    ...
    ...(ownerState.variant === 'outlined' &&
      ownerState.color !== 'default' && {
        ...
        [`&.${chipClasses.clickable}:hover`]: {
          backgroundColor: theme.vars
            ? `color-mix(${theme.vars.palette[ownerState.color].main} / transparent calc(${
