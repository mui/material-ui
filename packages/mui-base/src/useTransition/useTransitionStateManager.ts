 ...
 * Demos:
 *
 * - [Transitions](https://v6.mui.com/base-ui/react-transitions/#hooks)
 *
 * API:
 *
 * - [useTransitionStateManager API](https://v6.mui.com/base-ui/react-transitions/hooks-api/#use-transition-state-manager)
 */
