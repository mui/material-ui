 ...
 * Demos:
 *
 * - [Number Input](https://v6.mui.com/base-ui/react-number-input/#hook)
 *
 * API:
 *
 * - [useNumberInput API](https://v6.mui.com/base-ui/react-number-input/hooks-api/#use-number-input)
 */
