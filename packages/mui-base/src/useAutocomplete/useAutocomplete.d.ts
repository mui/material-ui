 ...
 * Demos:
 *
 * - [Autocomplete](https://v6.mui.com/base-ui/react-autocomplete/#hook)
 *
 * API:
 *
 * - [useAutocomplete API](https://v6.mui.com/base-ui/react-autocomplete/hooks-api/#use-autocomplete)
 */
