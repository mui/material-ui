...

{
  ...
  // https://github.com/mui/mui/issues/12277
...
{
  // https://github.com/mui/mui/issues/11109
...
{
  // https://github.com/mui/mui/issues/11191
  const styles = (theme: Theme) =>
    createStyles({
      main: {},
    });
...
{
  // https://github.com/mui/mui/issues/11312
...
{
  // https://github.com/mui/mui/issues/12670
  interface Props {
    nonDefaulted: string;
    defaulted: number;
  }
...
{
  // https://github.com/mui/mui/pull/15546
...

{
  ...
  // https://github.com/mui/mui/issues/16198
