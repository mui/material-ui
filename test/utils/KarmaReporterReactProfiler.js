...
function KarmaReporterReactProfiler(karmaConfig) {
  ...
  this.onBrowserComplete = (browser) => {
    ...
    if (browserRenders === undefined) {
      ...
      // For example, when starting the browser timed out in https://app.circleci.com/pipelines/github/mui/mui/32869/workflows/a2f398d9-2eb4-4390-a912-40c1b8d458d8/jobs/211413.
      console.warn(
