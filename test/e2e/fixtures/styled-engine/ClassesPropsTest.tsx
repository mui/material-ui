...
const Child = (props: { classes?: { root?: string }, className?: string, } )=> {
  ...
  return <div data-testid="child" className={clsx(classes.root, className, 'MuiChild-root')} {...other} />;
}
...
const Parent = (props: { classes?: { root?: string, slot?: string}, className?: string}) => {
  ...
  return (<ParentRoot data-testid="parent" className={clsx(classes.root, className, 'MuiParent-root')} {...other}>
