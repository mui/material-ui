...
- 🏗️ Improved the Select's component a11y by adding the combobox role and aria-controls attribute @xulingzhihou. If your tests require selecting the trigger element by the "button" role, then you'll have to change it to use "combobox" role instead
