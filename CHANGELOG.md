...
- 🏗️ Improved the Select's component a11y by adding combobox role and aria-controls attributes @xulingzhihou. If your tests require selecting the triggering element by the "button" role, then you'll have to change it to use "combobox" instead
