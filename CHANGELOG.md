...
- [system] set `before` directly without using prepend for global styles (#44648) @siriwatknp

### Docs

- [Accordion] Update `Anatomy` section in Accordion docs (#44849) @ZeeshanTamboli
- [CardActionArea] Added demo in docs of cards for adding props to CardActionArea (#44789) @siddhantantil39
...
- [docs-infra] Add vale coverage for App Router and Page Router (c5b0204) @oliviertassinari
...
- Fix Dashboard sidenav sroll (#44876) @oliviertassinari
- Fix broken anchor link to w3.org (c51af8e) @oliviertassinari
- Add details on complementary Menu components (#44957) @samuelsycamore
- Remove misleading messaging on MD3 support (#44953) @mnajdova
- Fix code copy button obscuring on small screen sizes (#44861) @ZeeshanTamboli
- Remove more instances of Adobe XD (#44956) @samuelsycamore
- Remove Adobe XD chips, links, and mentions (#44909) @samuelsycamore
- Fix incorrect rendering in Typography docs (#44937) @iaziz11
- Fix 301 redirections (16ff52a) @oliviertassinari
- Fix 301 redirections (2555845) @oliviertassinari
- Fix 301 redirections (8d34810) @oliviertassinari
- Add interactive demo for Grid v2 (#44820) @yash49
...
- [core] Update test to use public API (#44875) @oliviertassinari
- [core] Setup React 18 CI tests (#44868) @DiegoAndai
- [core] Fix docs:build to work in docs folder too (6b923a4) @oliviertassinari
- [core] Sync with other repos (1b9300f) @oliviertassinari
- [core] Remove unnecessary conditional around `.muiName = ` (#44071) @Janpot
- [example] Update the CDN example to adapt React 19. (#44979) @IceOfSummer
- [example] Update Next.js examples Next.js and React versions (#44852) @DiegoAndai
- [figma] Clarify that Material UI Sync plugin is experimental (#44975) @oliviertassinari

All contributors of this release in alphabetical order: @aarongarciah, @adityaparab, @alelthomas, @DiegoAndai, @good-jinu, @headironc, @iaziz11, @IceOfSummer, @Janpot, @komkanit, @lewxdev, @LukasTy, @mnajdova, @oliviertassinari, @romgrk, @sai6855, @samuelsycamore, @siddhantantil39, @siriwatknp, @yash49, @yashdev16, @ZeeshanTamboli
