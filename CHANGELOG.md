...
- ⚠️ **[BREAKING CHANGE]** Date pickers are removed from the lab, please follow the [migration guide](https://mui.com/x/react-date-pickers/migration-lab/). (#33386) @flaviendelangle
