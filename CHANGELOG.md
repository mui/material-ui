...
- &#8203;<!-- 10 -->[InputLabel] Fix condition for applying formControl overrides (#28707) @yevheniiminin
- &#8203;<!-- 09 -->[Stack] Add props & variants types in the theme (#28843) @mnajdova
- &#8203;<!-- 04 -->[Tooltip] Allow overriding internal components and their props (#28692) @michaldudak
- &#8203;<!-- 03 -->[transitions] Fix `addEndListener` not being called with the DOM node (#28715) @eps1lon

### `@mui/codemod@5.0.3`

- &#8203;<!-- 32 -->[codemod] Fix `optimal-imports` to support v4 and v5-alpha, beta (#28812) @siriwatknp

### `@mui/system@5.0.3`

- &#8203;<!-- 08 -->[system] Add padding/margin-block/inline to spacing (#28813) @smmoosavi

### `@mui/styled-engine-sc@5.0.3`

- &#8203;<!-- 37 -->Don't allow styled-components APIs on mui styled function (#28807) @hbjORbj

### `@mui/core@5.0.0-alpha.50`

- &#8203;<!-- 33 -->[ButtonUnstyled] Don't set redundant role=button (#28488) @michaldudak
- &#8203;<!-- 38 -->[SliderUnstyled] Prevent unknown-prop error when using marks prop (#28868) @hbjORbj

### `@mui/material-next@6.0.0-alpha.4`

- &#8203;<!-- 34 -->[Button-next] Create Button in material-next (#28313) @michaldudak

### Docs

- &#8203;<!-- 28 -->[docs] Fix typo in Pagination docs (#28864) @ZeeshanTamboli
- &#8203;<!-- 27 -->[docs] Fix 404 links (#28710) @mnajdova
- &#8203;<!-- 26 -->[docs] Fix typo in Mui CSS classname (#28725) @cacpgomes
- &#8203;<!-- 25 -->[docs] Match example to codesandbox demo and update ID link (#28762) @AnilSeervi
- &#8203;<!-- 24 -->[docs] Fix typo in system/box documentation (#28822) @iamsergo
- &#8203;<!-- 23 -->[docs] Use HTML standards for autocomplete attributes (#28827) @epodol
- &#8203;<!-- 22 -->[docs] Improve styled-components integration (#28713) @mnajdova
- &#8203;<!-- 21 -->[docs] Correct Select's menu placement description (#28748) @michaldudak
- &#8203;<!-- 20 -->[docs] AdapterDayJS -> AdapterDayjs (#28770) @veerreshr
- &#8203;<!-- 19 -->[docs] Theme documentation, typo fix (#28805) @saeedseyfi
- &#8203;<!-- 18 -->[docs] Add the last diamond sponsor (#28737) @hbjORbj
- &#8203;<!-- 17 -->[docs] Fix various links in CONTRIBUTING (#28751) @AnilSeervi
- &#8203;<!-- 16 -->[docs] Only add JSS to demos (#28698) @eps1lon
- &#8203;<!-- 15 -->[docs] Update v5 status in release schedule (#28700) @owais635
- &#8203;<!-- 29 -->[docs] Fix the wrong import in docs grid page (#28863) @taghi-khavari
- &#8203;<!-- 14 -->[docs] Fix typo in /guides/styled-engine (#28720) @Sharry0
- &#8203;<!-- 13 -->[docs] Fix typo in chip documentation (#28641) @avranju94
- &#8203;<!-- 12 -->[docs] Fix versions page (#28682) @mnajdova
- &#8203;<!-- 11 -->[docs] Remove legacy team page (#28646) @mnajdova
- &#8203;<!-- 36 -->[website] Add "React" to the hero description (#28830) @danilo-leal
...
- &#8203;<!-- 35 -->[website] Update Benny's profile on about us page (#28816) @hbjORbj

### Core

- &#8203;<!-- 31 -->[core] Remove `--exact` from `release:version` (#28840) @siriwatknp
- &#8203;<!-- 30 -->[core] Neglect framer from release flow (#28680) @siriwatknp
- &#8203;<!-- 07 -->[test] Add a test for not allowing styled-components' APIs on mui `styled` function (#28862) @hbjORbj
- &#8203;<!-- 06 -->[test] Fix instances where type tests were only passing due to object being part of ReactNode (#28804) @eps1lon
- &#8203;<!-- 05 -->[test] Move ByMuiTest to test/utils (#28509) @eps1lon
