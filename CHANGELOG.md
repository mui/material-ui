...
- 👩‍🎨 A first iteration on the new styling solution.
  ...
  In the event you are already using styled-components in your application, you can swap emotion for styled-components 💅. Check [this CodeSandbox](https://codesandbox.io/s/sliderstyled-with-styled-components-2hjs0?file=/src/demo.tsx) for a demo, it relies on aliases to prevent any bundle size overhead.
