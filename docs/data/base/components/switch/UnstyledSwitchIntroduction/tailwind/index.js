      ...
      slotProps={{
        ...
        track: (ownerState) => {
          ...
          return {
            ...resolvedSlotProps,
            className: clsx(
              `absolute block w-full h-full transition rounded-full border dark:border-gray-700 shadow-[inset_0_1_1_rgb(0_0_0_/_0.05)] dark:shadow-[inset_0_1_1_rgb(0_0_0_/_0.5)] ${
                ownerState.checked
                  ? 'bg-purple-500'
        ...
        thumb: (ownerState) => {
          ...
          return {
            ...resolvedSlotProps,
            className: clsx(
              `block w-4 h-4 top-1 rounded-2xl border dark:border-gray-700 transition shadow-[0_1px_2px_rgb(0_0_0_/_0.1)] dark:shadow-[0_1px_2px_rgb(0_0_0_/_0.25)] ${
                ownerState.checked ? 'left-[17px]' : 'left-[4px]'
              }  ${
