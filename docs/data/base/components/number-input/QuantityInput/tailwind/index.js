    ...
    <NumberInput
      slotProps={{
        ...
        incrementButton: {
          children: <AddIcon />,
          className:
            'order-1 text-sm box-border leading-normal border-0 rounded-full bg-transparent w-10 h-10 flex flex-row flex-nowrap justify-center items-center transition-all duration-[120ms] focus-visible:outline-0 hover:cursor-pointer hover:bg-purple-100 dark:hover:bg-purple-800',
        },
        decrementButton: {
          children: <RemoveIcon />,
          className:
            'text-sm box-border leading-normal border-0 rounded-full bg-transparent w-10 h-10 flex flex-row flex-nowrap justify-center items-center transition-all duration-[120ms] focus-visible:outline-0 hover:cursor-pointer hover:bg-purple-100 dark:hover:bg-purple-800',
        },
      }}
      {...props}
      ref={ref}
