  ...
  return (
    ...
    >
      <table
        ...
        className="text-sm font-sans [&>th]:p-4 [&>td]:p-4 border border-solid border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 rounded-xl shadow-md dark:shadow-[0_4px_16px_rgba(0,0,0,0.3)] w-full"
      >
        <tfoot>
          <tr>
      ...
      slotProps={{
        ...
        select: (ownerState) => {
          ...
          return {
            ...resolvedSlotProps,
            className: clsx(
              'p-[2px] border border-solid border-zinc-200 dark:border-zinc-800 rounded-3xl bg-transparent hover:bg-zinc-20 hover:dark:bg-zinc-800 focus:outline-0 [&>button:focus]:ring-[2px] focus:border-purple-400 focus:dark:border-purple-400 focus:hover:border-purple-400 focus:hover:dark:border-purple-400',
