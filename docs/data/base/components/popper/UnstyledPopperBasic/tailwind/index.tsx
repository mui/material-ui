...
export default function SimplePopper() {
  ...
  return (
    <div className={`${isDarkMode ? 'dark' : ''}`}>
      ...
      >
        <div className="z-50 m-1 rounded-lg border border-solid border-slate-200 bg-white p-3 font-sans text-sm font-medium text-slate-900 shadow-md dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100">
