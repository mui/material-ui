...
You could think of Base UI as the "skeletal" or "headless" version of Material UI—in fact, at some point in the future, every Material UI component should use these components and hooks for their foundational structure.
