...
You should now see the player render as shown on the screenshot above. But the component is not yet interactive—that's what we'll cover in the next step.
