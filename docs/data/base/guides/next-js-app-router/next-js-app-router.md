...
Jump right into the code with [this example: Base UI - Next.js App Router with Tailwind CSS example in TypeScript](https://github.com/mui/material-ui/tree/master/examples/base-next-tailwind-ts).
:::
...
Refer to this [example repo](https://github.com/mui/material-ui/tree/master/examples/base-next-tailwind-ts) for a full working demo of a Next.js 13 app using Base UI and Tailwind CSS.
