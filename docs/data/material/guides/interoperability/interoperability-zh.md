...
:::info If you are updating from `@material-ui/core` (v4) to `@mui/material` (v5) checkout [migration guide](/material-ui/guides/migration-v4/#2-use-tss-react). :::
