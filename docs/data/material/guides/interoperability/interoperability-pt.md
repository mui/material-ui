...
> Se você estiver atualizando de `@material-ui/core` (v4) para `@mui/material` (v5) checkout [guia de migração](/guides/migration-v4/#2-use-tss-react).
...
> ⚠️ For [Storybook](https://storybook.js.org): As of writing this lines storybook still uses by default emotion 10. Material UI e TSS executam a emoção 11 então há [algumas alterações](https://github.com/InseeFrLab/onyxia-ui/blob/324de62248074582b227e584c53fb2e123f5325f/.storybook/main.js#L31-L32) a serem feitas no seu `. storybook/main.js` para torná-lo usa a emoção 11.
