...
MUI doesn't provide a high-level API for solving this problem. Recomendamos que você explore [as soluções que a comunidade construiu](/material/components/autocomplete/).
