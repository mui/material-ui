...
Material-UI, não fornece uma API de alto nível para resolver este problema. You're encouraged you to explore [the solutions the React community has built](/material-ui/react-autocomplete/).
