...
作为品牌重塑工作的一部分，组织名和程序包名称已经从`@mui` 变更为 [`@mui`](https://www.npmjs.com/org/mui)。 您可以在这里[blog post](/blog/material-ui-is-now-mui/) 或者这里 [#27803](https://github.com/mui/material-ui/discussions/27803)查看更多细节。
