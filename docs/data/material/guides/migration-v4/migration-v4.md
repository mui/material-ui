...
Before upgrading to v5, please make sure that `ThemeProvider` is defined at the root of your application, including in tests,  (even if you are using the **default theme**) and **NO** `useStyles` is called before `<ThemeProvider>`.
