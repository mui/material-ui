...
- [Accordion](/material/components/accordion) - `HTMLDivElement`
- [Alert](/material/components/alert) - `HTMLDivElement`
- [Avatar](/material/components/avatar) - `HTMLDivElement`
- [ButtonGroup](/material/components/button-group) - `HTMLDivElement`
- [Card](/material/components/card) - `HTMLDivElement`
- [Dialog](/material/components/dialog) - `HTMLDivElement`
- [ImageList](/material/components/image-list) - `HTMLUListElement`
- [List](/material/components/list) - `HTMLUListElement`
- [Tab](/material/components/tabs) - `HTMLDivElement`
- [Tabs](/material/components/tabs) - `HTMLDivElement`
- [ToggleButton](/material/components/toggle-button) - `HTMLButtonElement`

##### `@mui/lab`

- [Timeline](/material/components/timeline) - `HTMLUListElement`
