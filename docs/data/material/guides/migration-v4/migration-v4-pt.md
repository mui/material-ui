...
<p spaces-before="2">:::success
✅ This is handled in the <a href="#preset-safe">preset-safe codemod</a> by applying fake <code>RootRef` component to prevent application crash, further fixes are required. ::: 
