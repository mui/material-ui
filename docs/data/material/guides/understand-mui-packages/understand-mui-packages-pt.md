...
In this article, we'll only cover the MUI Core packages. Check the [MUI X overview](/x/getting-started/overview) for more information about our collection of advanced components.
...
:::warning ⚠ **Note:** prior to v5, Material UI used `@mui/styles` as a JSS wrapper. This package is now deprecated and will be removed in the future. Check out [the guide to migrating from v4 to v5](https://mui.com/material-ui/guides/migration-v4/) to learn how to upgrade to a newer solution. :::
