...
import * as mui from '@mui/symbols-font';
import { Link } from '@mui/docs/Link';
import { useTranslate } from '@mui/docs/i18n';
import useQueryParameterState from 'docs/src/modules/utils/useQueryParameterState';

import Head from 'next/head';
import MUISymbolsOutlined400GoogleFont from '@mui/symbols-font/MUISymbolsOutlined400GoogleFont';
        ...
        <React.Fragment>
          ...
          >
            <Markdown
              ...
              code={`import ${selectedIcon.importName}Icon from '@mui/symbols/${selectedIcon.importName}';`}
              language="js"
            />
          </Tooltip>
          <ImportLink
...
const allIcons = Object.keys(mui)
  ...
  .map((importName) => {
    ...
    for (const currentTheme of ['Outlined', 'Rounded', 'Sharp']) {
...
export default function SearchIcons() {
  ...
  return (
    <Grid container sx={{ minHeight: 500, width: '100%' }}>
      <Head>
        <MUISymbolsOutlined400GoogleFont />
      </Head>
      <Grid
        size={{
          xs: 12,
