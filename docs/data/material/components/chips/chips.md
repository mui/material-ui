...
Chips automatically adapt to both light and dark color schemes. The following demo shows how different chip variants look in both themes:

{{"demo": "ChipDarkMode.js"}}
