...
Uma [grade](https://material.io/design/layout/responsive-layout-grid.html) cria consistência visual entre layouts, enquanto permite flexibilidade em uma ampla variedade de projetos. A interface responsiva do Material Design é baseada em um layout de grade de 12 colunas.
...
- Valores inteiros podem ser dados para cada ponto de quebra, indicando quantas das 12 colunas disponíveis são ocupadas pelo componente quando a largura da viewport satisfaz as [restrições de ponto de quebra](/material-ui/customization/breakpoints/#default-breakpoints).

Se você é **novo ou não está familiarizado com flexbox**, nós recomendamos que você leia este [guia de flexbox CSS-Tricks](https://css-tricks.com/snippets/css/a-guide-to-flexbox/).

## Grades fluídas

Grades fluídas usam colunas que escalam e redimensionam o conteúdo. O layout de uma grade fluída pode usar pontos de quebra para determinar se o leiaute precisa mudar drasticamente.

### Grade básica

Largura da coluna são valores inteiros entre 1 e 12; eles se aplicam em qualquer ponto de interrupção e indicam a quantidade de colunas ocupadas pelo componente.
