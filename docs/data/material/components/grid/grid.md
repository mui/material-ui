...
{{"component": "../data/material/components/grid/demos/basic/index.ts", "bg": true}}
...
{{"component": "../data/material/components/grid/demos/full-width/index.ts", "bg": true}}
...
{{"component": "../data/material/components/grid/demos/spacing/index.ts", "bg": true, "hideToolbar": true}}
...
{{"component": "../data/material/components/grid/demos/row-and-column-spacing/index.ts", "bg": true}}
...
{{"component": "../data/material/components/grid/demos/responsive/index.ts", "bg": true}}
...
{{"component": "../data/material/components/grid/demos/interactive/index.ts", "hideToolbar": true, "bg": true}}
...
{{"component": "../data/material/components/grid/demos/auto/index.ts", "bg": true}}
...
{{"component": "../data/material/components/grid/demos/variable-width/index.ts", "bg": true}}
...
{{"component": "../data/material/components/grid/demos/nested/index.ts", "bg": true}}

### Inheriting columns

A nested grid container inherits the columns from its parent unless the `columns` prop is specified to the instance.

{{"component": "../data/material/components/grid/demos/nested-columns/index.ts", "bg": true}}

## Columns

Use the `columns` prop to change the default number of columns (12) in the grid, as shown below:

{{"component": "../data/material/components/grid/demos/columns/index.ts", "bg": true}}
...
{{"component": "../data/material/components/grid/demos/offset/index.ts", "bg": true}}
...
{{"component": "../data/material/components/grid/demos/centered-element/index.ts", "bg": true}}
...
{{"component": "../data/material/components/grid/demos/full-bordered/index.ts"}}

### Half border

{{"component": "../data/material/components/grid/demos/half-bordered/index.ts"}}
...
{{"component": "../data/material/components/grid/demos/column-layout-inside/index.ts"}}
