...
> **注意：** 扩展面板将不再记录在 [Material Design 指南中](https://material.io/)，但 MUI 将继续支持它。 它之前被称为 "expansion panel（扩展面板）"。
...
以下是自定义扩展面板的一个示例。 You can learn more about this in the [overrides documentation page](/material-ui/customization/how-to-customize/).
