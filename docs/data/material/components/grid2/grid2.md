...
Since the new implementation is considered a breaking change, we introduced it as `Grid2` to gather feedbacks from the community before making it stable in the next major release of Material UI.
