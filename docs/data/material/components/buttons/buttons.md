...
The `@mui/base` package provides an unstyled version of the Button. If you would liek to opt out and use that one, you can find more information on it on the following [page](/base/components/button).
