...
- Você deve adicionar `pointer-events: none;` de volta quando você precisar exibir [dicas em elementos desabilitados](/material/components/tooltips/#disabled-elements).
