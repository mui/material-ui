...
Em algumas situações, talvez você não consiga usar o componente `Typography`. Hopefully, you might be able to take advantage of the [`typography`](/material-ui/customization/default-theme/?expand-path=$.typography) keys of the theme.
