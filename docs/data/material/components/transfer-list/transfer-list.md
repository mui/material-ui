...
{{"component": "../data/material/components/transfer-list/demos/transfer-list/index.ts", "bg": true}}

## Enhanced transfer list

This example exchanges the "move all" buttons for a "select all / select none" checkbox and adds a counter.

{{"component": "../data/material/components/transfer-list/demos/select-all/index.ts", "bg": true}}
