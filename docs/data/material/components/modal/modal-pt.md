...
Se você está criando um diálogo modal, você provavelmente quer usar o componente [Dialog](/material/components/dialogs/) em vez de diretamente um Modal. Modal é uma estrutura de baixo-nível que é aproveitada pelos seguintes componentes:

- [Dialog](/material/components/dialogs/)
- [Drawer](/material/components/drawers/)
- [Menu](/material/components/menus/)
- [Popover](/material/components/popover/)
