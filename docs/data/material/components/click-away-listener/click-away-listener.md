...
{{"component": "../data/material/components/click-away-listener/demos/click-away/index.ts"}}
...
{{"component": "../data/material/components/click-away-listener/demos/portal-click-away/index.ts"}}
...
{{"component": "../data/material/components/click-away-listener/demos/leading-click-away/index.ts"}}
