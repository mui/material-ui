...
Você pode fazer um diálogo totalmente responsivo usando [`useMediaQuery`](/material/components/use-media-query/#usemediaquery).
...
Veja a seção [Performance Modal](/material/components/modal/#performance).

## Limitations

Siga a [seção de limitações do Modal](/material/components/modal/#limitations).

## Accessibility

Siga a [seção de acessibilidade do Modal](/material/components/modal/#accessibility).
