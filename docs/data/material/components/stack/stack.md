...
{{"component": "../data/material/components/stack/demos/basic/index.ts", "bg": true}}
...
{{"component": "../data/material/components/stack/demos/direction/index.ts", "bg": true}}
...
{{"component": "../data/material/components/stack/demos/divider/index.ts", "bg": true}}

## Responsive values

You can switch the `direction` or `spacing` values based on the active breakpoint.

{{"component": "../data/material/components/stack/demos/responsive/index.ts", "bg": true}}
...
{{"component": "../data/material/components/stack/demos/flexbox-gap/index.ts", "bg": true}}
...
{{"component": "../data/material/components/stack/demos/interactive/index.ts", "hideToolbar": true, "bg": true}}
...
{{"component": "../data/material/components/stack/demos/zero-width/index.ts", "bg": true}}
