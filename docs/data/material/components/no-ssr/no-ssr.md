...
:::warning
Please refer to the [No-SSR](/base/react-no-ssr/) component page in the Base UI docs for demos and details on usage.

No-SSR is a part of the standalone [Base UI](/base/getting-started/overview/) component library.
