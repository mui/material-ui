...
- O componente é construído sobre o componente [`Modal`](/material/components/modal/).
- A rolagem e o clique fora não é permitido, ao contrário do componente [`Popper`](/material/components/popper/).
