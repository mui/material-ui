...
To use Tailwind CSS with Material UI components, you can start by cloning the [example project](https://github.com/mui/material-ui/tree/v9.x/examples/material-ui-vite-tailwind-ts) built with Vite and TypeScript.
