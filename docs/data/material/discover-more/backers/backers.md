...
<p style="display: flex; justify-content: start; align-items: center; flex-wrap: wrap;">
  ...
  <a data-ga-event-category="sponsor" data-ga-event-action="docs-backers" data-ga-event-label="rxdb.info" href="https://rxdb.info/?utm_source=sponsor&utm_medium=opencollective&utm_campaign=opencollective-mui" rel="noopener sponsored" target="_blank" style="margin-right: 16px;"><img height="96" width="96" src="https://rxdb.info/files/logo/logo.svg?s=96" srcset="https://rxdb.info/files/logo/logo.svg?s=192 2x" alt="tidelift.com" title="RxDB: Local-first JavaScript database." loading="lazy" /></a>
