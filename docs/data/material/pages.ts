  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        subheader: 'utils',
        children: [
          { pathname: '/material-ui/react-click-away-listener', title: 'Click-Away Listener', deprecated: true },
          ...
          { pathname: '/material-ui/react-textarea-autosize', title: 'Textarea Autosize', deprecated: true  },
