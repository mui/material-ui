...
const pages: MuiPage[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        pathname: '/material-ui/customization/cascade-layers',
        subheader: '/material-ui/customization/cascade-layers',
        newFeature: true,
        children: [{ pathname: '/material-ui/customization/css-layers', title: 'Cascade layers' }],
      },
    ],
  },
  {
