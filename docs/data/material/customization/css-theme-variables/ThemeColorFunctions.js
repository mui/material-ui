...
const colorSwatches = [
  { color: theme.palette.primary.main, key: 'primary' },
  { color: theme.palette.secondary.main, key: 'secondary' },
  { color: theme.palette.error.main, key: 'error' },
  { color: theme.palette.warning.main, key: 'warning' },
  { color: theme.palette.info.main, key: 'info' },
  { color: theme.palette.success.main, key: 'success' },
];
