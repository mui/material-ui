...
function BoxIndeterminateIcon(props) {
  return (
    <SvgIcon viewBox="0 0 16 16" {...props}>
      <rect x="0" y="0" width="16" height="16" rx="4" fill="currentColor" />
      <path
...
function CircleBlankIcon(props) {
  return (
    <SvgIcon viewBox="0 0 16 16" {...props}>
      <circle
        cx="8"
...
function CircleCheckedIcon(props) {
  return (
    <SvgIcon viewBox="0 0 16 16" {...props}>
      <circle
        cx="8"
