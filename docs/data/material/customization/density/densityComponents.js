...
export const DENSITY_COMPONENTS = {
  ...
  Badge: {
    ...
    render: (values) => (
      <Badge badgeContent={4} variant={values.variant} color="primary">
        <Avatar>M</Avatar>
      </Badge>
    ),
  },
  ...
  Checkbox: {
    ...
    render: (values) => (
      <FormControlLabel
        control={<Checkbox defaultChecked size={values.size} />}
  ...
  Fab: {
    ...
    render: (values) => (
      <Fab color="primary" size={values.size} aria-label="add">
        <AddIcon />
      </Fab>
    ),
  },
  ...
  Pagination: {
    ...
    render: (values) => <Pagination count={5} size={values.size} />,
  },
  Progress: {
  ...
  Radio: {
    ...
    render: (values) => (
      <FormControlLabel
        control={<Radio defaultChecked size={values.size} />}
  ...
  Slider: {
    ...
    render: (values) => (
      <Slider size={values.size} defaultValue={40} sx={{ width: 260 }} />
    ),
  },
  SnackbarContent: {
  ...
  SvgIcon: {
    ...
    render: (values) => <FavoriteIcon fontSize={values.fontSize} />,
  },
  Switch: {
    controls: [
      {
    ...
    render: (values) => (
      <FormControlLabel
        control={<Switch defaultChecked size={values.size} />}
        label="Auto-sync"
      />
    ),
  },
  ...
  ToggleButton: {
    ...
    render: (values) => (
      <ToggleButtonGroup value="left" exclusive size={values.size}>
