...
If you need to manipulate colors, `@mui/material/styles` provides [a set of utilities](https://github.com/mui/material-ui/blob/v9.x/packages/mui-material/src/styles/index.d.ts#L52-L67) to help with this.
