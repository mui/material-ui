    ...
    <div>
      <FormControl orientation="horizontal" sx={{ mb: 2, ml: 1 }}>
        ...
        <RadioGroup
          row
          value={borderAxis}
          onChange={(event) => setBorderAxis(event.target.value)}
        >
          <Radio label="xBetween" value="xBetween" />
          <Radio label="x" value="x" />
          <Radio label="yBetween" value="yBetween" />
          <Radio label="y" value="y" />
          <Radio label="bothBetween" value="bothBetween" />
