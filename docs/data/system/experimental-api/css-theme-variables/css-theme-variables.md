...
See the complete usage of `createCssVarsProvider` in [Material UI](https://github.com/mui/material-ui/blob/v9.x/packages/mui-material/src/styles/ThemeProviderWithVars.tsx).
