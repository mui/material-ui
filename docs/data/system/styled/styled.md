...
4. It adds by default `shouldForwardProp` option that is taking into account all props used internally in the MUI components: `ownerState`, `theme`, `sx`, `as` (can be overridden).
