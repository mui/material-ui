...
{{"component": "../data/system/getting-started/usage/demos/why/index.ts", "bg": true, "defaultCodeOpen": false}}
...
{{"component": "../data/system/getting-started/usage/demos/demo/index.ts", "bg": true, "defaultCodeOpen": true}}
...
{{"component": "../data/system/getting-started/usage/demos/breakpoints-as-object/index.ts"}}
...
{{"component": "../data/system/getting-started/usage/demos/container-queries/index.ts"}}
...
{{"component": "../data/system/getting-started/usage/demos/breakpoints-as-array/index.ts"}}
...
{{"component": "../data/system/getting-started/usage/demos/value-as-function/index.ts"}}
