...
{{"component": "../data/system/components/stack/demos/basic/index.ts", "bg": true}}
...
{{"component": "../data/system/components/stack/demos/direction/index.ts", "bg": true}}

## Dividers

Use the `divider` prop to insert an element between each child, as shown below:

{{"component": "../data/system/components/stack/demos/divider/index.ts", "bg": true}}

## Responsive values

You can switch the `direction` or `spacing` values based on the active breakpoint.

{{"component": "../data/system/components/stack/demos/responsive/index.ts", "bg": true}}
...
{{"component": "../data/system/components/stack/demos/flexbox-gap/index.ts", "bg": true}}

## Interactive demo

Below is an interactive demo that lets you explore the visual results of the different settings:

{{"component": "../data/system/components/stack/demos/interactive/index.ts", "hideToolbar": true, "bg": true}}
