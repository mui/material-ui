...
class Master extends React.Component {
 ...
 _getTabs() {
        ...
        <Paper zDepth={0} rounded={false} style={styles.root}>
          ...
          <div style={styles.container}>
            <Tabs onChange={this._onTabChange.bind(this)}
                  ...
                  unSelect={this.state.tabIndex === null}>
  ...
  _setTabsIndex() {
    let tabIndex =
      this.context.router.isActive('get-started') ? 0 :
      this.context.router.isActive('customization') ? 1 :
      this.context.router.isActive('components') ? 2 : null;
