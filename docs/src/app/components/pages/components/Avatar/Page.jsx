...
const description = 'Examples of `Avatar` using an image, [Font Icon](/#/components/icons/font-icon), ' +
  '[SVG Icon](/#/components/icons/svg-icon) and "Letter" (string), with and without custom colors.';
