...
const descriptions = {
  ...
  '[Icon Button](/#/components/buttons/icon-button) with tooltip for the second.',
  further: 'Badges containing an [Icon Button](/#/components/buttons/icon-button) and text, ' +
