...
/**
 *  `DateRangePicker` can be localised using the `locale` property. The first example is localised in French.
 ...
 */
const DateRangePickerExampleInternational = () => (
  <div>
    <DateRangePicker
      hintText="fr locale"
...
export default DateRangePickerExampleInternational;
