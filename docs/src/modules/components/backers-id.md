## Pendukung Material-UI

Material-UI adalah proyek open source dengan lisensi MIT.
...
Sponsor Emas adalah mereka yang telah menjanjikan $ 500 lebih / bulan ke Material-UI.
...
Lihat daftar lengkap [pendukung kami](/discover-more/backers/).
