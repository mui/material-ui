...
export const densityLabels: Record<string, string> = {
  'MuiAccordionDetails|root|base||padding': 'AccordionDetails · padding',
  'MuiAccordionSummary|content|base||margin': 'AccordionSummary · content · margin',
  'MuiAccordionSummary|content|fn:ya70cs|&.Mui-expanded|margin':
    'AccordionSummary · content · margin [fn]',
