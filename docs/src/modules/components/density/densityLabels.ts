...
export const densityLabels: Record<string, string> = {
  ...
  'MuiChip|root|size=medium|& .MuiChip-avatar|width': 'Chip · width [size=medium]',
  'MuiChip|root|size=medium|& .MuiChip-avatar|height': 'Chip · height [size=medium]',
  'MuiChip|root|size=medium|& .MuiChip-icon|fontSize': 'Chip · fontSize [size=medium]',
  'MuiChip|root|size=medium|& .MuiChip-deleteIcon|fontSize': 'Chip · fontSize [size=medium]',
  'MuiChip|root|size=small||--_height': 'Chip · --_height [size=small]',
  'MuiChip|root|size=small||height': 'Chip · height [size=small]',
  'MuiChip|root|size=small|& .MuiChip-avatar|width': 'Chip · width [size=small]',
  'MuiChip|root|size=small|& .MuiChip-avatar|height': 'Chip · height [size=small]',
  'MuiChip|root|size=small|& .MuiChip-icon|fontSize': 'Chip · fontSize [size=small]',
  'MuiChip|root|size=small|& .MuiChip-deleteIcon|fontSize': 'Chip · fontSize [size=small]',
