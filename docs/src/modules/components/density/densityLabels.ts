...
export const densityLabels: Record<string, string> = {
  ...
  'MuiSwitch|root|base||width': 'Switch · width',
  'MuiSwitch|root|base||height': 'Switch · height',
  'MuiSwitch|root|base||padding': 'Switch · padding',
  ...
  'MuiSwitch|root|size=small|& .MuiSwitch-thumb|width': 'Switch · width [size=small]',
  'MuiSwitch|root|size=small|& .MuiSwitch-thumb|height': 'Switch · height [size=small]',
  'MuiSwitch|root|size=small|& .MuiSwitch-switchBase|padding': 'Switch · padding [size=small]',
  'MuiSwitch|root|size=small|& .MuiSwitch-switchBase &.Mui-checked|transform':
    'Switch · transform [size=small]',
  'MuiSwitch|switchBase|base||top': 'Switch · switchBase · top',
  'MuiSwitch|switchBase|base||padding': 'Switch · switchBase · padding',
  'MuiSwitch|switchBase|base||left': 'Switch · switchBase · left',
  'MuiSwitch|switchBase|base|&.Mui-checked|transform': 'Switch · switchBase · transform',
  'MuiSwitch|switchBase|base|&.Mui-checked|left': 'Switch · switchBase · left',
  'MuiSwitch|thumb|base||width': 'Switch · thumb · width',
  'MuiSwitch|thumb|base||height': 'Switch · thumb · height',
  'MuiSwitch|track|base||borderRadius': 'Switch · track · borderRadius',
