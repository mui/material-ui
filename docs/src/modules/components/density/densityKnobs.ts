...
export const densityKnobs: Record<string, string | DensityKnobMeta> = {
  ...
  'MuiAlert|message|base||paddingBlock': 'Alert · message · paddingBlock',
  ...
  'MuiAlert|root|base|& .MuiAlert-icon|paddingBlock': 'Alert · paddingBlock',
  'MuiAlert|root|base|& .MuiAlert-icon|fontSize': 'Alert · fontSize',
  'MuiAlert|root|base|& .MuiAlert-action|padding': 'Alert · padding',
  'MuiAlert|root|base|& .MuiAlert-action|marginRight': 'Alert · marginRight',
  'MuiAlert|root|base|& .MuiAlert-action|alignSelf': 'Alert · alignSelf',
  ...
  'MuiButton|root|base||fontWeight': 'Button · fontWeight',
  'MuiButton|root|base||fontSize': 'Button · fontSize',
  'MuiButton|root|base||lineHeight': 'Button · lineHeight',
  'MuiButton|root|base||letterSpacing': 'Button · letterSpacing',
  'MuiButton|root|base||textTransform': 'Button · textTransform',
  'MuiButton|root|base||paddingBlock': { label: 'Button · paddingBlock', done: ['medium'] },
  'MuiButton|root|size=small||height': 'Button · height [size=small]',
  'MuiButton|root|size=small||paddingInline': 'Button · paddingInline [size=small]',
  'MuiButton|root|size=medium||height': 'Button · height [size=medium]',
  ...
  'MuiCheckbox|root|base||width': 'Checkbox · width',
  'MuiCheckbox|root|base||height': 'Checkbox · height',
  'MuiCheckbox|root|base|& svg|fontSize': 'Checkbox · fontSize',
  'MuiCheckbox|root|base|.MuiFormControlLabel-root &|marginLeft': 'Checkbox · marginLeft',
  'MuiCheckbox|root|size=small||--_touchSize': 'Checkbox · --_touchSize [size=small]',
  'MuiCheckbox|root|size=small||--_iconSize': 'Checkbox · --_iconSize [size=small]',
  'MuiCheckbox|root|edge=start||marginLeft': 'Checkbox · marginLeft [edge=start]',
  'MuiCheckbox|root|edge=end||marginRight': 'Checkbox · marginRight [edge=end]',
  'MuiChip|avatar|base||margin': 'Chip · avatar · margin',
  'MuiChip|avatar|base||width': 'Chip · avatar · width',
  'MuiChip|avatar|base||height': 'Chip · avatar · height',
  'MuiChip|avatar|base||marginLeft': 'Chip · avatar · marginLeft',
  'MuiChip|deleteIcon|base||margin': 'Chip · deleteIcon · margin',
  'MuiChip|deleteIcon|base||width': 'Chip · deleteIcon · width',
  'MuiChip|deleteIcon|base||height': 'Chip · deleteIcon · height',
  'MuiChip|deleteIcon|base||marginRight': 'Chip · deleteIcon · marginRight',
  'MuiChip|icon|base||margin': 'Chip · icon · margin',
  ...
  'MuiChip|label|base||paddingInline': 'Chip · label · paddingInline',
  'MuiChip|root|size=medium||height': 'Chip · height [size=medium]',
  'MuiChip|root|size=medium||paddingInline': 'Chip · paddingInline [size=medium]',
  'MuiChip|root|size=medium||gap': 'Chip · gap [size=medium]',
  'MuiChip|root|size=medium||--_childSize': 'Chip · --_childSize [size=medium]',
  'MuiChip|root|size=medium||--_offset': 'Chip · --_offset [size=medium]',
  'MuiChip|root|size=small||height': 'Chip · height [size=small]',
  'MuiChip|root|size=small||paddingInline': 'Chip · paddingInline [size=small]',
  'MuiChip|root|size=small||gap': 'Chip · gap [size=small]',
  'MuiChip|root|size=small||--_childSize': 'Chip · --_childSize [size=small]',
  'MuiChip|root|size=small||--_offset': 'Chip · --_offset [size=small]',
  ...
  'MuiFormControlLabel|root|base||margin': 'FormControlLabel · margin',
  ...
  'MuiIconButton|root|base||fontSize': 'IconButton · fontSize',
  'MuiIconButton|root|size=small||width': 'IconButton · width [size=small]',
  'MuiIconButton|root|size=small||height': 'IconButton · height [size=small]',
  'MuiIconButton|root|size=medium||width': 'IconButton · width [size=medium]',
  'MuiIconButton|root|size=medium||height': 'IconButton · height [size=medium]',
  'MuiIconButton|root|size=large||width': 'IconButton · width [size=large]',
  'MuiIconButton|root|size=large||height': 'IconButton · height [size=large]',
  ...
  'MuiPaginationItem|root|size=large||height': 'PaginationItem · height [size=large]',
  'MuiPaginationItem|root|size=large||minWidth': 'PaginationItem · minWidth [size=large]',
  'MuiPaginationItem|root|fn:ryjquw||height': 'PaginationItem · height [fn]',
  ...
  'MuiRadio|root|base||--_touchSize': 'Radio · --_touchSize',
  'MuiRadio|root|base||--_iconSize': 'Radio · --_iconSize',
  'MuiRadio|root|base||padding': 'Radio · padding',
  'MuiRadio|root|base||width': 'Radio · width',
  'MuiRadio|root|base||height': 'Radio · height',
  'MuiRadio|root|base|& svg|fontSize': 'Radio · fontSize',
  'MuiRadio|root|base|.MuiFormControlLabel-root &|marginLeft': 'Radio · marginLeft',
  'MuiRadio|root|size=small||--_touchSize': 'Radio · --_touchSize [size=small]',
  'MuiRadio|root|size=small||--_iconSize': 'Radio · --_iconSize [size=small]',
  'MuiRadio|root|edge=start||marginLeft': 'Radio · marginLeft [edge=start]',
  'MuiRadio|root|edge=end||marginRight': 'Radio · marginRight [edge=end]',
