...
Material-UI — это проект с открытым исходным кодом, опубликованный под лицензией MIT. Это независимый проект, постоянно находящийся в разроботке благодаря поддержке этих замечательных [ людей ](/discover-more/backers/).
...
<p style="display: flex; justify-content: center;">
  ...
  <a data-ga-event-category="sponsors" data-ga-event-action="logo" data-ga-event-label="bitsrc" href="https://bitsrc.io" rel="noopener" target="_blank" style="margin-right: 16px;"><img width="96" src="https://avatars1.githubusercontent.com/u/24789812?s=192" alt="bitsrc" title="Самый быстрый способ поделиться кодом"></a>
</p>
