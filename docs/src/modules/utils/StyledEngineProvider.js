  ...
  return (
    <StyleSheetManager stylisPlugins={rtl ? [rtlPlugin] : []}>
      <CacheProvider value={emotionCache}>
        <GlobalStyles styles="@layer theme, docsearch, mui, mui.global, mui.default, mui.default-variants, mui.theme, mui.theme-variants, mui.custom, mui.custom-variants, mui.sx, utilities;" />
        {children}
      </CacheProvider>
    </StyleSheetManager>
  );
