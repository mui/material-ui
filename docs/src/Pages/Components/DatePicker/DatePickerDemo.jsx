...
const DatePickerDemo = () => (
  <div>
    ...
    <Typography variant="body1">
      The selected day is indicated by a filled circle. The current day is indicated by a different color and type
      weight.
    </Typography>

    <SourcablePanel title="Basic usage" sourceFile="Components/DatePicker/BasicDatePicker.example.jsx" />

    <SourcablePanel title="Keyboard input" sourceFile="Components/DatePicker/KeyboardDatePicker.example.jsx" />

    <SourcablePanel title="Inline mode" sourceFile="Components/DatePicker/InlineDatePicker.example.jsx" />
