...
const rootStyles = `color: var(--palette-primary);
width: 100%;
padding: 16px 0;
...
<Slider
  ...
  slotProps={{
    ...
    rail: {
      className: 'block absolute w-full h-[4px] 
      rounded-[2px] bg-current opacity-40',
    },
    track: {
      className: 'block absolute h-[4px] 
      rounded-[2px] bg-current',
    },
    thumb: {
      className:
        'absolute w-[16px] h-[16px] -ml-[6px] 
