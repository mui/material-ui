      ...
      <Grid container spacing={{ xs: 2, sm: 4 }}>
        ...
        <Grid item xs={12} sm={6}>
          <Paper variant="outlined" sx={{ p: 2, height: '100%' }}>
            ...
            <Typography variant="body2" color="text.secondary">
              With your purchase, you are entitled to technical support (for to MUI X components)
              and access to new versions for the duration of your subscription. You can{' '}
