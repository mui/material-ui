      ...
      >
        ...
        <Box display="flex" flexDirection="column" gap={3}>
          <Paper variant="outlined" sx={{ p: 2, height: 'fit-content' }}>
            ...
            <Typography variant="body2" color="text.secondary">
              ...
              <br />
              The difference regards the right to use the components for development purposes. Only
              the perpetual license type allows you to continue development once your license
              expires.
            </Typography>
          </Paper>
          <Paper variant="outlined" sx={{ p: 2, height: 'fit-content' }}>
        ...
        <Box display="flex" flexDirection="column" gap={3}>
          <Paper variant="outlined" sx={{ p: 2, height: 'fit-content' }}>
            ...
            <Typography variant="body2" color="text.secondary">
              The Annual license type requires an active license to use the software in development.
