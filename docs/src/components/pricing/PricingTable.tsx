...
const communityData: Record<string, React.ReactNode> = {
  // Core
  '@mui/core': <IconImage name="yes" title="Available" />,
  '@mui/material': <IconImage name="yes" title="Available" />,
  '@mui/system': <IconImage name="yes" title="Available" />,
  // Advanced
  ...
  'data-grid/row-sorting': <IconImage name="yes" title="Available" />,
  'data-grid/row-height': <IconImage name="yes" title="Available" />,
  ...
  'data-grid/row-selection': <IconImage name="yes" title="Available" />,
  ...
  'data-grid/filter-column': <IconImage name="yes" title="Available" />,
  'data-grid/filter-multicolumn': <IconImage name="no" title="Not included" />,
  'data-grid/pagination': <IconImage name="yes" title="Available" />,
  'data-grid/pagination-large': <IconImage name="no" title="Not included" />,
  'data-grid/edit-row': <IconImage name="yes" title="Available" />,
  'data-grid/edit-cell': <IconImage name="yes" title="Available" />,
  'data-grid/file-csv': <IconImage name="yes" title="Available" />,
  'data-grid/file-print': <IconImage name="time" title="Work in progress" />,
  'data-grid/file-clipboard': <IconImage name="no" title="Not included" />,
  'data-grid/file-excel': <IconImage name="no" title="Not included" />,
  'data-grid/customizable-components': <IconImage name="yes" title="Available" />,
  'data-grid/virtualize-column': <IconImage name="yes" title="Available" />,
  ...
  'data-grid/accessibility': <IconImage name="yes" title="Available" />,
  'data-grid/keyboard-nav': <IconImage name="yes" title="Available" />,
  'data-grid/localization': <IconImage name="yes" title="Available" />,
  'data-grid-pro': <IconImage name="no" title="Not included" />,
  'date-range-picker': <IconImage name="no" title="Not included" />,
  // Support
  community: <IconImage name="yes" title="Available" />,
  'bugs/features': <IconImage name="yes" title="Available" />,
...
const proData: Record<string, React.ReactNode> = {
  ...
  'data-grid/column-groups': <IconImage name="time" title="Work in progress" />,
  'data-grid/column-spanning': <IconImage name="time" title="Work in progress" />,
  'data-grid/column-resizing': <IconImage name="yes" title="Available" />,
  'data-grid/column-reorder': <IconImage name="yes" title="Available" />,
  ...
  'data-grid/row-selection': <IconImage name="yes" title="Available" />,
  'data-grid/row-multiselection': <IconImage name="yes" title="Available" />,
  'data-grid/row-rangeselection': <IconImage name="no" title="Not included" />,
  'data-grid/filter-quick': <IconImage name="time" title="Work in progress" />,
  'data-grid/filter-column': <IconImage name="yes" title="Available" />,
  'data-grid/filter-multicolumn': <IconImage name="yes" title="Available" />,
  'data-grid/pagination': <IconImage name="yes" title="Available" />,
  'data-grid/pagination-large': <IconImage name="yes" title="Available" />,
  'data-grid/edit-row': <IconImage name="yes" title="Available" />,
  'data-grid/edit-cell': <IconImage name="yes" title="Available" />,
  'data-grid/file-csv': <IconImage name="yes" title="Available" />,
  'data-grid/file-print': <IconImage name="time" title="Work in progress" />,
  ...
  'data-grid/customizable-components': <IconImage name="yes" title="Available" />,
  'data-grid/virtualize-column': <IconImage name="yes" title="Available" />,
  'data-grid/virtualize-row': <IconImage name="yes" title="Available" />,
  ...
  community: <IconImage name="yes" title="Available" />,
  'bugs/features': (
    <Info value={<IconImage name="yes" title="Available" />} metadata="Priority over Community" />
  ),
  'tech-advisory': <IconImage name="no" title="Not included" />,
...
const premiumData: Record<string, React.ReactNode> = {
  ...
  community: <IconImage name="yes" title="Available" />,
  'bugs/features': (
    <Info value={<IconImage name="yes" title="Available" />} metadata="Priority over Pro" />
  ),
