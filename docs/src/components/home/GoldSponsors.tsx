...
const GOLDs = [
  ...
  },
  {
    ...
    name: 'DialMyCalls',
    description: 'Send text messages, calls, and emails to thousands.',
  ...
  },
  {
    ...
    name: 'Goread.io',
    description: 'Instagram followers, likes, power likes, views, and comments.',
  ...
  },
  {
    ...
    name: 'Icons8',
    description: 'Developer API for icons, photos, illustrations, and music.',
