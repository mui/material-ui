        ...
        >
          ...
          >
            <Route
              title="Color"
              path="/style/color"
              content={requireDocs('./style/color/color.md')}
              component={MarkdownDocs}
              nav
            />
            <Route
              title="Icons"
              path="/style/icons"
              content={requireDocs('./style/icons/icons.md')}
              component={MarkdownDocs}
              nav
            />
            <Route
              ...
              content={requireDocs('./style/typography/typography.md')}
              component={MarkdownDocs}
              nav
            />
          </Route>
          ...
          >
            <Route
              ...
              content={requireDocs('./layout/responsive-ui/responsive-ui.md')}
              component={MarkdownDocs}
              nav
            />
          </Route>
