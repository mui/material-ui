const ROUTES = {
  ...
  githubOrg: 'https://github.com/mui-org',
  stackOverflowMuiTag: 'https://stackoverflow.com/questions/tagged/mui',
  twitterMui: 'https://twitter.com/MaterialUI',
  linkedInMui: 'https://www.linkedin.com/company/mui/',
