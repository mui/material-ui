...
- Ele encaminha as propriedades _non React static_ para que este HOC seja mais "transparente". Por exemplo, pode ser usado para definir um método estático (next.js) `getInitialProps ()`.
