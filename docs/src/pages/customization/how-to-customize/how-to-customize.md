...
If you find that you need the same overrides in multiple places across your application, you can use the [`experimentalStyled()`](/customization/experimental-styled/) utility for creating a reusable component:
