...
Alternatively, you can always have a look at the [implementation](https://github.com/mui-org/material-ui/blob/v3.x/packages/material-ui/src/Button/Button.js).
