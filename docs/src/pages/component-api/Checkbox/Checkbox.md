...
| name | string |  |  |
| onChange | function |  | Callback function that is fired when the switch is changed.<br><br>**Signature:**<br>`function(event: object, checked: boolean) => void`<br>*event:* `change` event<br>*checked:* The `checked` value of the switch |
