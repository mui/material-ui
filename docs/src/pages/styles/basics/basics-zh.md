...
- 📦低于[15KB压缩](https://bundlephobia.com/result?p=@mui/styles)；若和 Material-UI 一起使用，将不会有捆绑的尺寸增加。

## 安装

> 我们将 `@mui/styles` 导出为 `@mui/material/styles` ——若你想和 Material-UI 分开使用，只需单独安装它。
