...
- 🚀 [Fast enough](https://github.com/mui-org/material-ui/blob/v3.x/packages/material-ui-benchmark/README.md#material-uisystem) not to be a bottleneck at runtime.
