...
- The runtime performance takes a hit.
  ...
  _Head to the [benchmark folder](https://github.com/mui/mui/tree/next/benchmark/browser) for a reproduction of these metrics._
...
TODO [#23220](https://github.com/mui/mui/issues/23220).
