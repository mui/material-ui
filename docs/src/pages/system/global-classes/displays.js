export const displays = {
  ...
  '.d-print-table-column-group': { '@media print': { display: 'table-column-group' }},
  '.d-print-table-header-group': { '@media print': { display: 'table-header-group' }},
  '.d-print-table-footer-group': { '@media print': { display: 'table-footer-group' }},
  '.d-print-table-row-group': { '@media print': { display: 'table-row-group' }},
