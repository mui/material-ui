...
<p style="display: flex; justify-content: center;">
  ...
  <a data-ga-event-category="sponsor" data-ga-event-action="logo" data-ga-event-label="bitsrc" href="https://bit.dev" rel="noopener sponsored" target="_blank" style="margin-right: 16px;"><img height="96" width="96" src="https://github.com/teambit.png?size=96" srcset="https://github.com/teambit.png?size=192 2x" alt="- Device platform: arm64-v8a
...
! Installation failed
" title="コードを共有する最速の方法" loading="lazy" /></a>
</p>
<p style="display: flex; justify-content: center;">
