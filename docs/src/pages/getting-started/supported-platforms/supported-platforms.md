...
An extensive list can be found in our [.browserlistrc](https://github.com/mui/mui/blob/master/.browserslistrc#L12-L27) (check the `stable` entry).
...
You can use [the documentation implementation](https://github.com/mui/mui/blob/47aa5aeaec1d4ac2c08fd0e84277d6b91e497557/pages/_document.js#L123) as inspiration.
