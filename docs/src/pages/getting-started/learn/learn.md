...
Like any unfamiliar technology, Material-UI does have a learning curve. With practice and some patience, you will get the hang of it.
...
Sometimes people find third-party blog posts, books and video courses more helpful than the official documentation. We maintain a list of commonly recommended resources, some of which are free.
...
- **Learn React & Material-UI**: a series of videos covering all the important Material-UI's components.
...
- **Elegant UX in React with Material-UI**: a blog post covering some important concepts of Material-UI.
