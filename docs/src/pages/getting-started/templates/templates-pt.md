...
Os modelos podem ser combinados com uma das [aplicações de exemplo](https://github.com/mui/mui/tree/master/examples) para gerar um projeto inicial completo.
...
Se, ao usar estes exemplos você faz mudanças ou melhorias que poderiam melhorar a experiência do desenvolvedor, ou você gostaria de contribuir com um exemplo adicional, por favor considere a criação de um [pull request no GitHub](https://github.com/mui/mui/pulls).
