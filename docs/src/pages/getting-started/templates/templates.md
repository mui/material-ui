...
The templates can be combined with one of the [example projects](https://github.com/mui/mui/tree/master/examples) to form a complete starter.
...
please consider creating a [pull request on GitHub](https://github.com/mui/mui/pulls).
