...
Ищите что-то большее?  Вы можете найти готовые темы в <a href="https://mui.com/store/?utm_source=docs&utm_medium=referral&utm_campaign=templates-store" data-ga-event-category="store" data-ga-event-action="click" data-ga-event-label="templates">магазине тем</a>.
