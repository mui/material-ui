...
class ConfirmationDialog extends React.Component<$FlowFixMeProps, $FlowFixMeState> {
...
class ConfirmationDialogDemo extends React.Component<$FlowFixMeProps, $FlowFixMeState> {
  static defaultProps: $FlowFixMeProps;
  state = {
    anchorEl: undefined,
    open: false,
