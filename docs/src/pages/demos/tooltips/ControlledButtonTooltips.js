...
class ButtonTooltips extends React.Component {
  state = {
    iconButtonTooltipOpen: false,
    fabTooltipOpen: false,
    placement: 'bottom',
  };

  handleIconButtonRequestClose = () => {
    this.setState({ iconButtonTooltipOpen: false });
  };

  handleIconButtonRequestOpen = () => {
    this.setState({ iconButtonTooltipOpen: true });
  };

  handleFabRequestClose = () => {
    this.setState({ fabTooltipOpen: false });
  };

  handleFabRequestOpen = () => {
    this.setState({ fabTooltipOpen: true });
  };
      ...
      <div className={classes.root}>
        <div>
          <Tooltip
            ...
            open={this.state.iconButtonTooltipOpen}
          ...
          <Tooltip
            ...
            label="Add"
            onRequestClose={this.handleFabRequestClose}
            onRequestOpen={this.handleFabRequestOpen}
            open={this.state.fabTooltipOpen}
            placement={this.state.placement}
          >
