...
interface ChipsPlaygroundProp extends WithStyles<typeof styles> {}
...
class ChipsPlayground extends React.Component<ChipsPlaygroundProp, ChipsPlaygroundState> {
  state: ChipsPlaygroundState = {
    color: 'default',
    onDelete: 'none',
    avatar: 'none',
    icon: 'none',
  ...
  handleChange = (key: ActionType) => (event: React.ChangeEvent<{}>, value: string) => {
    this.setState({
      [key]: value,
    } as Pick<ChipsPlaygroundState, keyof ChipsPlaygroundState>);
  };
