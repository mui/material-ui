...
- [UXPin](https://github.com/uxpin-merge/material-ui-5-merge): A large UI kit of MUI components. The components are rendered directly from the React implementation, they are not handcrafted.
