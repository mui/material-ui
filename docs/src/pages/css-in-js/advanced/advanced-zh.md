...
JSS使用插件的概念来扩展其核心，允许人们挑选他们需要的功能。 你仅为你正在使用的内容支付性能开销。 All the plugins aren't available by default. 我们添加了以下列表：
...
It's a subset of [jss-preset-default](https://cssinjs.org/jss-preset-default/). 当然，你可以自由的添加新插件。 Here is an example with the [jss-rtl](https://github.com/alitaheri/jss-rtl) plugin.
...
如果您不喜欢此默认行为, 您可以更改它。 JSS relies on the concept of [class name generator](https://cssinjs.org/jss-api/#generate-your-class-names).
