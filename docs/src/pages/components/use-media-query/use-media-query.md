...
2. `options` (*Object* [optional]):
  ...
  You can provide a global ponyfill using [`custom properties`](/customization/component-overrides/#default-props) on the theme. Check the [server-side rendering example](#server-side-rendering).
