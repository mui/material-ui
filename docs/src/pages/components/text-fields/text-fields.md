...
In the future, we might provide a [number input component](https://github.com/mui/mui/issues/19154).
...
The following demo uses the [react-imask](https://github.com/uNmAnNeR/imaskjs) and [react-number-format](https://github.com/s-yadav/react-number-format) libraries. The same concept could be applied to [e.g. react-stripe-element](https://github.com/mui/mui/issues/16037).
