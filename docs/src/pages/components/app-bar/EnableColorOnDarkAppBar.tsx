      ...
      <Box sx={{ flexGrow: 1 }}>
        <FormGroup>
          <FormControlLabel
            ...
            label={enableColorOnDarkMode ? 'Disable Color on Dark' : 'Enable Color on Dark'}
          />
        </FormGroup>
        <AppBar color="primary" position="static" enableColorOnDark={enableColorOnDarkMode} >
          <Toolbar variant="dense">
            ...
            <div>
              ...
              <IconButton sx={{ ml: 1 }} onClick={themeModeHandleChange} color="inherit">
