...
The Box component packages [all the style functions](/system/basics/#all-inclusive) that are provided by `@material-ui/system`.
It's created using the [`experimentalStyled()`](/customization/styled/) function of `@material-ui/core/styles`.
