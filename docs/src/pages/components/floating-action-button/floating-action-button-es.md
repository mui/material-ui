...
Sólo usa un FAB si es la forma más adecuada de presentar la acción principal de una pantalla. Sólo usa un FAB si es la forma más adecuada de presentar la acción principal de una pantalla.
