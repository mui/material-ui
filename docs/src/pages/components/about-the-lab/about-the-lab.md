...
- It needs to be **used**. The Material-UI team uses Google Analytics on the documentation, among other metrics to evaluate the usage of each component. A lab component with low usage either means that it isn't fully working yet or that there is a low demand for it.
