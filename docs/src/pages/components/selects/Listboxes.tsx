...
function renderOption(optionState: any, optionProps: Record<string, unknown>) {
...
function CustomListbox<TOption>(props: UseListboxProps<TOption>) {
...
const customReducer: CustomListboxReducer<string> = (
  state,
  action,
  internalReducer,
) => {
  ...
  return (
    <div style={{ display: 'flex', flexWrap: 'wrap' }}>
      <Box m={4}>
        ...
        <CustomListbox
          defaultValue={'Earth'}
          onChange={(value) => console.log('Single select onChange', { value })}
          options={options}
      ...
      <Box m={4}>
        ...
        <CustomListbox
          ...
          onChange={(value) => setSelectedPlanet(value)}
          options={options}
        />
      ...
      <Box m={4}>
        ...
        <CustomListbox<string>
          value={selectedPlanets}
          selectMultiple
          onChange={(value) => setSelectedPlanets(value)}
          options={options}
        />
        <p>
          Selected planets:
