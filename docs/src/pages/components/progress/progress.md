...
<p class="description">Progress indicators and spinners express an unspecified wait time or display the length of a process. The animation works with CSS, not JavaScript.</p>
