...
- It only works on desktop.
  ...
  If mobile support is important for you, have a look at [#27579](https://github.com/mui/mui/issues/27579).
- There are no high-level components exported from npm. The demos are based on composition.
  If this is important for you, have a look at [#27579](https://github.com/mui/mui/issues/27579).
