...
Como um componente CSS utilitário, o `Grid` suporta todas as propriedades [`do sistema`](/system/properties/). Você pode usá-los como "props" diretamente no componente. Por exemplo, um preenchimento:
