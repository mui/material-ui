...
ブレークポイントの `up` プロパティを使用すると、指定したもの _以上_のブレークポイントであるとき_子要素_が非表示になります。

{{"demo": "pages/components/hidden/BreakpointUp.js", "bg": true}}

## ブレイクポイント

ブレークポイントの `down` プロパティを使用すると、指定したもの _以下_のブレークポイントであるとき_子要素_が非表示になります。

{{"demo": "pages/components/hidden/BreakpointDown.js", "bg": true}}

## Breakpoint only

ブレークポイントの `only` プロパティを使用すると、指定した_子要素_ が特定のブレークポイント(複数可)_で_非表示になります。

`only` プロパティは以下の2つの方法で使うことができます。
