...
- [The reference implementation of this tutorial](https://github.com/mui-org/material-ui/tree/master/examples/ssr-next)
- [Gatsby](https://github.com/mui-org/material-ui/tree/master/examples/gatsby-next)
- [Next.js](https://github.com/mui-org/material-ui/tree/master/examples/nextjs-next)
