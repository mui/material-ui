...
> Este documento está em constante evolução. If you have upgraded your site and run into something that's not covered here, please [add your changes on GitHub](https://github.com/mui/mui/blob/HEAD/docs/src/pages/guides/migration-v4/migration-v4.md).
...
Esta página de documentação cobre o _como_ migrar da v4 para a v5. O _por que_ é abordado na [postagem no blog do Medium](https://medium.com/material-ui/material-ui-v4-is-out-4b7587d1e701).
...
- para maiores detalhes (veja [.browserslistrc (seção `stable`)](https://github.com/mui/mui/blob/HEAD/.browserslistrc#L11))
...
Você pode usar o [codemod `moved-lab-modules`](https://github.com/mui/mui/tree/HEAD/packages/material-ui-codemod#moved-lab-modules) para realizar uma migração automática.
