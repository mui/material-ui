...
The [example folder](https://github.com/mui/mui/tree/HEAD/examples/nextjs-with-typescript) provides adapters for usage with MUI.

- The first version of the adapter is the [`NextLinkComposed`](https://github.com/mui/mui/tree/HEAD/examples/nextjs-with-typescript/src/Link.tsx) component.
