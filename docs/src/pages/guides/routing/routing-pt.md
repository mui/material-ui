...
Aqui estão algumas demonstrações com [react-router](https://github.com/ReactTraining/react-router). Você pode aplicar a mesma estratégia com todos os componentes: BottomNavigation, Card, etc.
