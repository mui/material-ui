...
Properties supplied to a component which are not explictly documented, are spread to the root element;
...
- their own `xxxRef` property when users might need to perform imperative actions,
...
renders. If you pass a different component via the `component` prop,docs: the ref will be attached
