...
- [Create React App with styled-components](https://github.com/mui/mui/blob/next/examples/create-react-app-with-styled-components)
- [Create React App with styled-components and typescript](https://github.com/mui/mui/blob/next/examples/create-react-app-with-styled-components-typescript)
- [Next.js app with styled-components and TypeScript](https://github.com/mui/mui/blob/next/examples/nextjs-with-styled-components-typescript)
