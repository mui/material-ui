...
If you are used to Tailwind CSS and you want to use it together with the MUI components, you should follow the following steps:
...
Now you can start using Tailwind CSS on the MUI components
