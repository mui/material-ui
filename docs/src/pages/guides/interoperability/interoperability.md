...
[You can target the class names generated by Material-UI](/css-in-js/advanced/#with-material-ui-core).
...
The best approach to ensuring styled-components styles are loaded last is to change [the CSS injection order](/css-in-js/advanced/#css-injection-order), as in the demo:
