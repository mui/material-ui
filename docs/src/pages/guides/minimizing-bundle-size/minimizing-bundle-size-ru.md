...
При таком прямом импорте минуются директивы экспорта [главного файла модуля `@mui/material`](https://unpkg.com/@mui/material), этот файл может служить в качестве удобного перечня общедоступных модулей.
