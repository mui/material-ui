...
> [Add your changes on GitHub](https://github.com/mui/mui/blob/next/docs/src/pages/guides/migration-v3/migration-v3.md).
...
- `theme.spacing.unit` usage is deprecated, you can use the new API:
  ...
  You can use [the migration helper](https://github.com/mui/mui/tree/master/packages/mui-codemod/README.md#theme-spacing-api) on your project to make this smoother.
...
- [Typography] Rename `color="default"` to `color="initial"` following the logic of [this thread](https://github.com/mui/mui/issues/13028).
