...
MUI requires a minimum version of TypeScript 3.5. Have a look at the [Create React App with TypeScript](https://github.com/mui/mui/tree/next/examples/create-react-app-with-typescript) example.
