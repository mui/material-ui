...
MUI was started [4 years ago](https://github.com/mui/mui/commit/28b768913b75752ecf9b6bb32766e27c241dbc46).
...
- Way better [test coverage](/guides/testing/) (99%+, run on all the major browsers, [visual regression tests](https://www.argos-ci.com/mui/mui))
...
2. Run [the migration helper](https://github.com/mui/mui/tree/master/packages/mui-codemod) on your project.
...
In the future, we will look into providing a simple component to solve the simple use cases: [#9997](https://github.com/mui/mui/issues/9997).

### Svg Icon

Run [the migration helper](https://github.com/mui/mui/tree/master/packages/mui-codemod) on your project.
...
There is an open issue in order to finish this migration guide [#7195](https://github.com/mui/mui/issues/7195). Any pull request is welcomed 😊.
