...
Material-UI startete im Jahr 2014 um React und Material-Design zu vereinheitlichen. Today, Material-UI has grown to become one of the world's most popular React UI libraries, backed by a vibrant community of more than 1M developers in over 180 countries.
