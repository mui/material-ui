...
- **Help guide architectural decisions**. The future of Material-UI is discussed and planned in our public RFCs and issues. You'll be helping drive these conversations and guiding Material-UI toward the best possible solutions.
- **Contribute to deep, meaningful refactors and feature releases**. Material-UI is a complex codebase. Components we've shipped recently, such as the DataGrid have required months of dedicated, careful work.
