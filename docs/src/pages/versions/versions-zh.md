...
{{"demo": "pages/versions/ReleasedVersions.js", "hideToolbar": tre, "bg": "inline"}}
...
MUI follows [Semantic Versioning 2.0.0](https://semver.org/). MUI version numbers have three parts: `major.minor.patch`. 版本号的递增是根据发行的更改级别而定义的。
