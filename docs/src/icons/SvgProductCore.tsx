...
function SvgComponent(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <mask id="prefix__a" maskUnits="userSpaceOnUse" x={11} y={6} width={14} height={15}>
        <path
      ...
      <mask id="prefix__b" maskUnits="userSpaceOnUse" x={4} y={10} width={14} height={15}>
        <path
      ...
      <mask id="prefix__c" maskUnits="userSpaceOnUse" x={18} y={10} width={15} height={15}>
        <path
      ...
      <mask id="prefix__d" maskUnits="userSpaceOnUse" x={11} y={14} width={14} height={15}>
        <path
      ...
      <g mask="url(#prefix__d)" fillRule="evenodd" clipRule="evenodd">
