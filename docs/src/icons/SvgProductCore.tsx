...
export default function SvgProductCore(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      ...
      <mask id="product-core-mask1" maskUnits="userSpaceOnUse" x={11} y={6} width={14} height={15}>
        <path
      ...
      <mask id="product-core-mask2" maskUnits="userSpaceOnUse" x={4} y={10} width={14} height={15}>
        <path
      ...
      <mask id="product-core-mask3" maskUnits="userSpaceOnUse" x={18} y={10} width={15} height={15}>
        <path
      ...
      <mask id="product-core-mask4" maskUnits="userSpaceOnUse" x={11} y={14} width={14} height={15}>
        <path
