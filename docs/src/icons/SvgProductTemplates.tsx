...
function SvgComponent(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <mask id="prefix__a" maskUnits="userSpaceOnUse" x={12} y={5} width={17} height={17}>
        <path
      ...
      <mask id="prefix__b" maskUnits="userSpaceOnUse" x={4} y={10} width={16} height={17}>
        <path
      ...
      <mask id="prefix__c" maskUnits="userSpaceOnUse" x={16} y={13} width={16} height={17}>
        <path
