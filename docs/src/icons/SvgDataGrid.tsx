...
function SvgSparkline({ active, ...props }: { active?: boolean } & React.SVGProps<SVGSVGElement>) {
    ...
    >
      ...
      <g mask="url(#svg-sparkline1)">
        <path
          ...
          fill="url(#svg-sparkline2)"
        />
        <g filter="url(#svg-sparkline3)">
          <path
