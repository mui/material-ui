...
| <span class="prop-name">valueFilled</span> | <span class="prop-name">Mui-valueFilled</span> | Pseudo-class applied to the root element if the corresponding `input` element's `value` is not empty.
