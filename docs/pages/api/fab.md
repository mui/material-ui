...
| <span class="prop-name">size</span> | <span class="prop-type">enum:&nbsp;'small'<br>&#124;&nbsp;'medium'<br>&#124;&nbsp;'large'</span> | <span class="prop-default">'large'</span> | The size of the button. `small` is equivalent to the dense button styling. |
| <span class="prop-name">variant</span> | <span class="prop-type">enum:&nbsp;'round'<br>&#124;&nbsp;'extended'</span> | <span class="prop-default">'round'</span> | The variant to use. |
