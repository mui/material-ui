...
| <span class="prop-name">direction</span> | <span class="prop-type">enum:&nbsp;'up'<br>&#124;&nbsp;'down'<br>&#124;&nbsp;'left'<br>&#124;&nbsp;'right'</span> | <span class="prop-default">'up'</span> | The direction the actions open relative to the floating action button. |
