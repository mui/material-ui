...
| <span class="prop-name">colorError</span> | <span class="prop-name">MuiChip-colorError</span> | Styles applied to the root element if `color="error"`.
...
| <span class="prop-name">clickableColorError</span> | <span class="prop-name">MuiChip-clickableColorError</span> | Styles applied to the root element if `onClick` and `color="error"` is defined or `clickable={true}`.
...
| <span class="prop-name">deletableColorError</span> | <span class="prop-name">MuiChip-deletableColorError</span> | Styles applied to the root element if `onDelete` and `color="error"` is defined.
...
| <span class="prop-name">outlinedError</span> | <span class="prop-name">MuiChip-outlinedError</span> | Styles applied to the root element if `variant="outlined"` and `color="error"`.
...
| <span class="prop-name">avatarColorError</span> | <span class="prop-name">MuiChip-avatarColorError</span> | Styles applied to the `avatar` element if `color="error"`.
...
| <span class="prop-name">iconColorError</span> | <span class="prop-name">MuiChip-iconColorError</span> | Styles applied to the `icon` element if `color="error"`.
...
| <span class="prop-name">deleteIconColorError</span> | <span class="prop-name">MuiChip-deleteIconColorError</span> | Styles applied to the deleteIcon element if `color="error"` and `variant="default"`.
...
| <span class="prop-name">deleteIconOutlinedColorError</span> | <span class="prop-name">MuiChip-deleteIconOutlinedColorError</span> | Styles applied to the deleteIcon element if `color="error"` and `variant="outlined"`.
