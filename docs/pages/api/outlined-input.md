...
| <span class="prop-name">colorInherit</span> | <span class="prop-name">.MuiOutlinedInput-colorInherit</span> | Styles applied to the root element if the color is inherit.
