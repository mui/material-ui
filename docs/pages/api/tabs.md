...
| <span class="prop-name">indicatorColor</span> | <span class="prop-type">'secondary'<br>&#124;&nbsp;'primary'<br>&#124;&nbsp;'error'</span> | <span class="prop-default">'secondary'</span> | Determines the color of the indicator. |
...
| <span class="prop-name">textColor</span> | <span class="prop-type">'secondary'<br>&#124;&nbsp;'primary'<br>&#124;&nbsp;'error'<br>&#124;&nbsp;'inherit'</span> | <span class="prop-default">'inherit'</span> | Determines the color of the `Tab`. |
