...
| <span class="prop-name">forcePopupIcon</span> | <span class="prop-type">string</span> | <span class="prop-default">'auto'</span> | Force the visibility display of the popup icon. |
