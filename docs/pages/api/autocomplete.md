...
| <span class="prop-name">CloseIconComponent</span> | <span class="prop-type">elementType</span> |  | `Icon` to be displayed instead of the default `CloseIcon`. |
...
| <span class="prop-name">PopupIconComponent</span> | <span class="prop-type">elementType</span> |  | `Icon` to be displayed instead of the default `ArrowDropDownIcon`. |
