...
| <a class="anchor-link" id="props--disableUnderline"></a><a href="#props--disableUnderline" class="prop-name">disableUnderline</a> | <span class="prop-type">bool</span> |  | If `true`, the input will not have an underline. |
