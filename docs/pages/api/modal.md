...
| <span class="prop-name">container</span> | <span class="prop-type">union:&nbsp;object<br>&#124;&nbsp;func</span> |  | A node, component instance, or function that returns either. The `container` will have the portal children appended to it. |
