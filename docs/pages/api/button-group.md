...
| <span class="prop-name">orientation</span> | <span class="prop-type">'horizontal'<br>&#124;&nbsp;'vertical'</span> | <span class="prop-default">'horizontal'</span> | The group orientation. |
...
| <span class="prop-name">horizontal</span> | <span class="prop-name">MuiButtonGroup-horizontal</span> | Styles applied to child elements if `orientation={horizontal}`.
| <span class="prop-name">vertical</span> | <span class="prop-name">MuiButtonGroup-vertical</span> | Styles applied to child elements if `orientation={vertical}`.
