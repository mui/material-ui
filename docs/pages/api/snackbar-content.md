...
| <span class="prop-name">role</span> | <span class="prop-type">string</span> |  | The role of the SnackbarContent. If the SnackbarContent includes interactive controls, such as a link, "alertdialog" should be used; otherwise use "alert". |
