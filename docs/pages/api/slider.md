...
| <span class="prop-name">defaultValue</span> | <span class="prop-type">number<br>&#124;&nbsp;arrayOf</span> |  | The default element value. Use when the component is not controlled. |
...
| <span class="prop-name">value</span> | <span class="prop-type">number<br>&#124;&nbsp;arrayOf</span> |  | The value of the slider. For ranged sliders, provide an array with two values. |
