...
| <span class="prop-name">colorError</span> | <span class="prop-name">MuiSlider-colorError</span> | Styles applied to the root element if `color="error"`.
...
| <span class="prop-name">thumbColorError</span> | <span class="prop-name">MuiSlider-thumbColorError</span> | Styles applied to the thumb element if `color="error"`.
