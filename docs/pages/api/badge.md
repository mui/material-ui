...
| <span class="prop-name">color</span> | <span class="prop-type">enum:&nbsp;'default'<br>&#124;&nbsp;'primary'<br>&#124;&nbsp;'secondary'<br>&#124;&nbsp;'error'</span> | <span class="prop-default">'default'</span> | The color of the component. It supports those theme colors that make sense for this component. |
...
| <span class="prop-name">variant</span> | <span class="prop-type">enum:&nbsp;'standard'<br>&#124;&nbsp;'dot'</span> | <span class="prop-default">'standard'</span> | The variant to use. |
