...
| <a class="anchor-link" id="props--raised"></a><a href="#props--raised" title="link to the prop on this page" class="prop-name">raised</a> | <span class="prop-type">bool</span> | <span class="prop-default">false</span> | If `true`, the card will use raised styling. |
...
|:-----|:-------------|:------------|
| <a class="anchor-link" title="link to the rule name on this page" id="css--root"></a><a href="#css--root" class="prop-name">root</a> | <span class="prop-name">.MuiCard-root</span> | Styles applied to the root element.
