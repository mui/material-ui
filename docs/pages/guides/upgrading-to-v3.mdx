...
We done a lot of work to make state-management of pickers more obvios and simplify form integration experience.
...
Previously keyboard mode was a bit painful, especially from form inegration prospective.
...
Checkout [new example](/guides/controlling-programmatically)
