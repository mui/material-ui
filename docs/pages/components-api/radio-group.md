...
Any other properties supplied will be provided to the root element ([FormGroup](/components-api/form-group/)).

## Inheritance

The properties of the [FormGroup](/components-api/form-group/) component are also available.
