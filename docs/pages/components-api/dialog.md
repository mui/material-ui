...
| <span class="prop-name">PaperProps</span> | <span class="prop-type">object</span> | <span class="prop-default">{}</span> | Props applied to the [`Paper`](/components-api/paper/) element. |
...
Any other properties supplied will be provided to the root element ([Modal](/components-api/modal/)).
...
The properties of the [Modal](/components-api/modal/) component are also available.
