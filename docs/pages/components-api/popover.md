...
| <span class="prop-name">ModalClasses</span> | <span class="prop-type">object</span> |  | `classes` prop applied to the [`Modal`](/components-api/modal/) element. |
...
| <span class="prop-name">PaperProps</span> | <span class="prop-type">{ component?: element type }</span> | <span class="prop-default">{}</span> | Props applied to the [`Paper`](/components-api/paper/) element. |
