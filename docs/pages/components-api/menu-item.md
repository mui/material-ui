...
Any other properties supplied will be provided to the root element ([ListItem](/components-api/list-item/)).
...
The properties of the [ListItem](/components-api/list-item/) component are also available.
