...
| <span class="prop-name">MenuListProps</span> | <span class="prop-type">object</span> | <span class="prop-default">{}</span> | Props applied to the [`MenuList`](/components-api/menu-list/) element. |
...
| <span class="prop-name">PopoverClasses</span> | <span class="prop-type">object</span> |  | `classes` prop applied to the [`Popover`](/components-api/popover/) element. |
...
Any other properties supplied will be provided to the root element ([Popover](/components-api/popover/)).
...
The properties of the [Popover](/components-api/popover/) component are also available.
