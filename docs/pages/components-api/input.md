...
Any other properties supplied will be provided to the root element ([InputBase](/components-api/input-base/)).
...
The properties of the [InputBase](/components-api/input-base/) component are also available.
