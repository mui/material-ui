...
| <span class="prop-name">TypographyClasses</span> | <span class="prop-type">object</span> |  | `classes` prop applied to the [`Typography`](/components-api/typography/) element. |
...
Any other properties supplied will be provided to the root element ([Typography](/components-api/typography/)).
...
The properties of the [Typography](/components-api/typography/) component are also available.
