...
|:-----|:-----|:--------|:------------|
| <span class="prop-name">ButtonProps</span> | <span class="prop-type">object</span> |  | Props applied to the [`Button`](/components-api/button/) component. |
...
| <span class="prop-name">TooltipClasses</span> | <span class="prop-type">object</span> |  | Classes applied to the [`Tooltip`](/components-api/tooltip/) element. |
...
Any other properties supplied will be provided to the root element ([Tooltip](/components-api/tooltip/)).
...
The properties of the [Tooltip](/components-api/tooltip/) component are also available.
