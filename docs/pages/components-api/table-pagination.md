...
| <span class="prop-name">backIconButtonProps</span> | <span class="prop-type">object</span> |  | Props applied to the back arrow [`IconButton`](/components-api/icon-button/) component. |
...
| <span class="prop-name">nextIconButtonProps</span> | <span class="prop-type">object</span> |  | Props applied to the next arrow [`IconButton`](/components-api/icon-button/) element. |
...
| <span class="prop-name">SelectProps</span> | <span class="prop-type">object</span> | <span class="prop-default">{}</span> | Props applied to the rows per page [`Select`](/components-api/select/) element. |

The `ref` is forwarded to the root element.

Any other properties supplied will be provided to the root element ([TableCell](/components-api/table-cell/)).
...
The properties of the [TableCell](/components-api/table-cell/) component are also available.
