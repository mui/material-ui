...
Any other properties supplied will be provided to the root element ([FormLabel](/components-api/form-label/)).
...
The properties of the [FormLabel](/components-api/form-label/) component are also available.
