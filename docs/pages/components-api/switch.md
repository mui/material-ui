...
Any other properties supplied will be provided to the root element ([IconButton](/components-api/icon-button/)).
...
The properties of the [IconButton](/components-api/icon-button/) component are also available.
