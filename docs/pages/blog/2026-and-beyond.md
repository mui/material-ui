...
description: An update on active projects, maintenance, and our focus areas into the new year.
...
Over the last months, we've seen more questions from the community about the status of different MUI projects and where our focus is heading.
...
Joy UI is also currently on hold.

We have no active plans or timelines to share, and the team is not focused on advancing at this time.
...
One clear takeaway from community feedback is that it's not enough to quietly shift priorities. We need to be clearer and more consistent about what's active, what's stable, and what's on hold.
