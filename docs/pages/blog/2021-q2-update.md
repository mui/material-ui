...
- 🔥 We've made enough progress to ship [v5.0.0-beta.0](https://github.com/mui/mui/releases/tag/v5.0.0-beta.0). Here are a few statistics to give an idea of the effort that went into it:

  - [12 months](/blog/2020-q2-update/#product) of dedicated focus.
    We stopped work on v4 early on to fully dedicate to v5.
  - 3,475 pull requests.
  - 5,092 commits (the extra commits came from the merge of [material-ui-pickers](https://github.com/mui/mui-pickers))
...
- ⚒️ We added a [codemod CLI](https://github.com/mui/mui/tree/HEAD/packages/mui-codemod) and 17 transformations (so far) to automatically migrate codebases from v4 to v5.
...
- ⭐️ From 67.2k to 69.1k stars. [Leave us yours 🌟](https://github.com/mui/mui)!
...
- [Jun](/blog/siriwat-kunaporn-joining/), leads the implementation of a [second design system](https://github.com/mui/mui/issues/22485).
...
- [Michał](/blog/michal-dudak-joining/) leads the initiative around the [unstyled components](https://github.com/mui/mui/issues/6218).
...
- 🦴 Migrate more components to `@mui/core`. [Michał](https://github.com/michaldudak) has recently added support for the [Switch](https://mui.com/components/switches/#unstyled).
  You can follow our progress in the [umbrella issue](https://github.com/mui/mui/issues/27170).
...
- 🗓 Execute on all of the items in the [public roadmap](https://github.com/mui/mui/projects/25).
- ❓ Please upvote [GitHub issues](https://github.com/mui/mui/issues?q=is%3Aissue+is%3Aopen+sort%3Areactions-%2B1-desc) if you want us to focus on a specific problem. The number of 👍 helps us to prioritize.
