...
While we are currently working on the upcoming release of Material-UI v5, we need to prioritize our
roadmap for the coming year. To refine our focus, we launched a developer survey few months back,
to which we received 1488 contributions. This year we had twice as more contributions than last year,
...
(promoters less detractors) of 61.54%. Given the NPS range of -100 to +100, a “positive” score or NPS
...
<img src="/static/blog/2020-survey/4.jpg" style="display: block; margin: 0 auto;" alt="Word cloud of the main benefit of Material-UI" />

The responses variously commented on being able to focus on the business logic, faster development,
