...
- 👩‍🎤 We have worked on rolling out and scaling the new **styling engine** to all the components.
  ...
  We are almost done! You can subscribe to [material-ui#24405](https://github.com/mui/mui/issues/24405) to be notified once finished.
...
- 📚 To complement the migration of the components, we have worked on the migration of the code examples in the documentation,
  ...
  You can subscribe to [material-ui#16947](https://github.com/mui/mui/issues/16947) to be notified once finished.
...
- 🎨 We have improved the support for custom colors and variants.
  This is [one](https://github.com/mui/mui/issues/13875) of the most upvoted issues in the GitHub issue tracker.
...
- ⭐️ From 63.8k to 67.2k stars, leave us yours [🌟](https://github.com/mui/mui).
