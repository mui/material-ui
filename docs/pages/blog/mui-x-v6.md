...
Cell selection is a powerful and flexible way to select data in the Data Grid. It’s also the base for bulk editing and clipboard importing (coming soon).
...
- Removed clock view [](/x/react-date-pickers/fields/)on desktop Time Pickers
...
For more details, feel free to follow our [public roadmap](https://github.com/mui/mui-x/projects/1).
