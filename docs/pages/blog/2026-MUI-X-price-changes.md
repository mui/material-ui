...
Customers with perpetual licenses can also request a **new v9 license key**. This key will grant access to all v9 versions released **before** your support and maintenance expiration date listed on your license key. It does not extend your maintenance and support access beyond the original date of your order.
