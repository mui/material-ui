...
- 📈 From 4.6M to 5.96M unique visitors per year on the documentation.
- ⭐️ From 63.8 to 74.0k stars, leave us [yours 🌟](https://github.com/mui/material-ui).
- 👨‍👩‍👧‍👦 From 2,052 to [2,396](https://github.com/mui/material-ui/graphs/contributors) contributors, +344.
