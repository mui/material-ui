...
- 🚧 We have started the quarter with the first pre-release [v5.0.0-alpha.1](https://github.com/mui/mui/releases?after=v5.0.0-alpha.1) of the next major iteration of the library.
...
- 🛠 We have migrated parts of the codebase to TypeScript.<br />
  We had to work on the code infrastructure of _mui/mui_ to prepare to host the date picker components that are written in TypeScript inside the lab (coming from _mui/mui-pickers_ that we will archive once we can).
...
- 🐙 We have migrated large parts of the test suite to react-testing-library.<br>
  15 months ago, we introduced the very [first test](https://github.com/mui/mui/pull/15732) using the library (to replace enzyme). Last month, react-testing-library had [more downloads](https://npm-stat.com/charts.html?package=enzyme&package=%40testing-library%2Freact&from=2019-10-10&to=2020-10-10) than enzyme!
...
- ♿︎ We have kept investing in accessibility, we have fixed [13 bugs](https://github.com/mui/mui/pulls?q=is%3Apr+label%3Aaccessibility+is%3Aclosed+sort%3Aupdated-desc).
- 🗓 We have introduced public quarterly roadmaps, both for [community](https://github.com/mui/mui/projects) and [enterprise](https://github.com/mui/mui-x/projects).
...
- ⭐️ From 59.0k to 61.6k stars, leave us yours [🌟](https://github.com/mui/mui).
...
- 🗓 Execute on all the items of the [public roadmap](https://github.com/mui/mui/projects/25).
- 👩‍🎨 Simplify the migration experience from v4 to v5.
- ❓ Please upvote [GitHub issues](https://github.com/mui/mui/issues) if you want us to focus on a specific problem. The number of 👍 helps us to prioritize.
...
- 🏢 We might hire a full-time designer that has coding skills. One of the objectives would be to solve [#22485](https://github.com/mui/mui/issues/22485).
