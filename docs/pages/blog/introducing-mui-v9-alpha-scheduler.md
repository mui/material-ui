...
For the complete v9 story across Material UI and MUI X, see the [Material UI and MUI X v9 overview](/blog/introducing-mui-v9/).
...
- Start with the [Material UI and MUI X v9 overview](/blog/introducing-mui-v9/).
