...
Two years ago, we decided to move away [from inline-styles toward **CSS-in-JS**](https://github.com/oliviertassinari/a-journey-toward-better-style). We are very happy with the outcome. We would like to thank [@kof](https://github.com/kof) for the awesome work he has done with [JSS](https://github.com/cssinjs/jss), the internal solution we use. It’s allowing us to be [interoperable](https://material-ui.com/guides/interoperability/) with all the other styling solutions.

- **Theme**. You can’t have a good customizability story without a good theming story. We have been redesigning the theme. It’s a [JavaScript object](https://material-ui.com/customization/default-theme/) that contains all the variables and utility functions you might need to style your components: a palette, a typography, breakpoints helpers, transition helpers, etc.
