...
Toolpad supports bringing your external components to the project. Your past effort should not go to waste—we don’t believe in a walled garden approach. In the future, we’ll also support importing from Storybook and GitHub.
...
Toolpad works with your code editor and lets you write custom functions. These functions:
