...
After over 400 days of development and over 40 canary releases, we are excited to introduce [MUI Core v5.0.0](https://github.com/mui/mui/releases/tag/v5.0.0)!
...
You can find the initial RFC plan for v5 in [issue #20012](https://github.com/mui/mui/issues/20012).
...
3. Many developers were advocating for MUI to [migrate to styled-components](https://github.com/mui/mui/issues/6115),
...
After [exploring](https://github.com/mui/mui/issues/22342) many different options, we settled on what we believe is a great tradeoff to **solve** the above issues:
...
2. We have defined a common interface with concrete implementations:
   ...
   - If you are using a different styling library, feel free to contribute a wrapper. For instance, there is [one attempt with goober](https://github.com/mui/mui/pull/27776), a library obsessing on bundle size (3kB gzipped).
...
We would like to thank all the community contributors that made the migration of the components and documentation possible in [#24405](https://github.com/mui/mui/issues/24405) and [#16947](https://github.com/mui/mui/issues/16947): [@natac13](https://github.com/natac13), [@vicasas](https://github.com/vicasas), [@mngu](https://github.com/mngu), [@kodai3](https://github.com/kodai3), [@xs9627](https://github.com/xs9627), [@povilass](https://github.com/povilass), [@duganbrett](https://github.com/duganbrett), [@vinyldarkscratch](https://github.com/vinyldarkscratch), and more.
...
This was one of the most upvoted GitHub issues: [#13875](https://github.com/mui/mui/issues/13875).
...
We discuss the effort in [#6218](https://github.com/mui/mui/issues/6218).
You can use [#27170](https://github.com/mui/mui/issues/27170) to follow our progress.
...
Instead, we have reversed the priority, putting the developers using them [first](https://github.com/mui/mui/issues/22484).
...
With this organic adoption strategy, it might take us two years to close [#15984](https://github.com/mui/mui/issues/15984).
...
Thanks for the patience, this has been an old and [frequently requested](https://github.com/mui/mui/issues/13394) improvement.
...
These changes have allowed us to save [6 kB gzipped](https://github.com/mui/mui/pull/22814#issuecomment-700995216) on the `@mui/material` package.
...
You can read more about them in [the docs](/customization/unstyled-components/) and keep track of our progress in [#27170](https://github.com/mui/mui/issues/27170).
...
There are [RFCs](https://github.com/mui/mui/issues?q=is%3Aopen+label%3Adiscussion+%5BRFC%5D) waiting for your feedback.
Don't hesitate to let us know what you think!

### Second design system

Developing a new design system is one of the main initiatives, alongside this new brand and the unstyled components, to grow MUI beyond Material Design. Its codename is **Joy** and we have just started [the high-level discussion](https://github.com/mui/mui/discussions/27803) around it.
