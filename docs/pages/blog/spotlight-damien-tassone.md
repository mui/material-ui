...
description: Damien Tassone has joined MUI. They's the first full-time member to focus on enterprise components.
...
Prior to joining MUI, Damien worked in the finance industry in London for a decade. Part of the initial Agile Market team at RBS, and more recently leading a large Commodity Trading application at Adaptive, Damien has developed their React experience as part of large projects where Components driven design plays a huge role in successfully delivering applications. They loves TypeScript.
