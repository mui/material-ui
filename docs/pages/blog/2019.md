...
- ⭐️ From 43.1k to 53.3k stars, leave us [yours 🌟](https://github.com/mui/mui).
- 👨‍👩‍👧‍👦 From 1,064 to [1,581](https://github.com/mui/mui/graphs/contributors) contributors.
...
- We have fixed a significant number of [accessibility issues](https://github.com/mui/mui/issues?q=is%3Aissue+label%3Aaccessibility+is%3Aclosed).
