...
const data = [
  ...
  {
    id: 2,
    label: 'I can easily customize the components to match the desired design and behavior',
  ...
  {
    id: 5,
    label: 'Whenever I need help, I can find helpful responses (Stack Overflow or GitHub)',
