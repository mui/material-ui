...
That's why we created Material UI Sync, a Figma plugin for generating styles that can be copied and pasted straight into your Material UI app's theme.
...
Material UI Sync relies on these local variables to generate code corresponding to each element and state.
...
- Check out documentation for [the Material UI Sync plugin](/material-ui/design-resources/connect/) and [the Material UI Design Kit](/material-ui/design-resources/material-ui-for-figma/).
