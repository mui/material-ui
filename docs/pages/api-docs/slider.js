...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'Slider');
  const classDescriptions = mapApiTranslations(req2, 'Slider');
  const classConditions = mapApiTranslations(req3, 'Slider');
