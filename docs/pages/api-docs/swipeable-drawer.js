...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'SwipeableDrawer');
  const classDescriptions = mapApiTranslations(req2, 'SwipeableDrawer');
  const classConditions = mapApiTranslations(req3, 'SwipeableDrawer');
