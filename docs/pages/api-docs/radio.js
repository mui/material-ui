...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'Radio');
  const classDescriptions = mapApiTranslations(req2, 'Radio');
  const classConditions = mapApiTranslations(req3, 'Radio');
