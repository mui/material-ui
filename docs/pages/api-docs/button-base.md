...
| <span class="prop-name">type</span> | <span class="prop-type">'button'<br>&#124;&nbsp;'reset'<br>&#124;&nbsp;'submit'</span> | <span class="prop-default">'button'</span> | Used to control the button's purpose. This prop passes the value to the `type` attribute of the native button component. |
