...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'TimelineSeparator');
  const classDescriptions = mapApiTranslations(req2, 'TimelineSeparator');
  const classConditions = mapApiTranslations(req3, 'TimelineSeparator');
