...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'Snackbar');
  const classDescriptions = mapApiTranslations(req2, 'Snackbar');
  const classConditions = mapApiTranslations(req3, 'Snackbar');
