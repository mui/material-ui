...
import jsonPageContent from './theme-provider.json';
...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'ThemeProvider');
  const classDescriptions = mapApiTranslations(req2, 'ThemeProvider');
  const classConditions = mapApiTranslations(req3, 'ThemeProvider');
