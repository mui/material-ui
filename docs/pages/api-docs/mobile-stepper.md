...
If that's not sufficient, you can check the [implementation of the component](https://github.com/mui-org/material-ui/blob/next/packages/material-ui/src/MobileStepper/MobileStepper.js) for more detail.
