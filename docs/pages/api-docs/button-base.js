...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'ButtonBase');
  const classDescriptions = mapApiTranslations(req2, 'ButtonBase');
  const classConditions = mapApiTranslations(req3, 'ButtonBase');
