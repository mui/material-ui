...
| <span class="prop-name">iconClickExpandOnly</span> | <span class="prop-type">bool</span> | <span class="prop-default">false</span> | if true clicking on label will not expand |
