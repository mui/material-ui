...
| <span class="prop-name">labelProps</span> | <span class="prop-type">object</span> |  | Props for every TreeItem Typography label wrapper Can be overridden on each TreeItem with TreeItem labelProps prop. |
