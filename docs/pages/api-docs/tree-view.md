...
| <span class="prop-name">onNodeToggle</span> | <span class="prop-type">func</span> |  | Callback fired when tree items are expanded/collapsed<br><br>**Signature:**<br>`function(event: object, nodeIds: string[], reason: Keyboard \| IconClick \| LabelClick) => void`<br>*event:* The event source of the callback.<br>*nodeIds:* The ids of the expanded nodes.<br>*reason:* The reason for the expansion / collapse. |
