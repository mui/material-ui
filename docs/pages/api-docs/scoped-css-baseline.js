...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'ScopedCssBaseline');
  const classDescriptions = mapApiTranslations(req2, 'ScopedCssBaseline');
  const classConditions = mapApiTranslations(req3, 'ScopedCssBaseline');
