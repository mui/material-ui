...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'SnackbarContent');
  const classDescriptions = mapApiTranslations(req2, 'SnackbarContent');
  const classConditions = mapApiTranslations(req3, 'SnackbarContent');
