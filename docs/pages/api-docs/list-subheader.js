...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'ListSubheader');
  const classDescriptions = mapApiTranslations(req2, 'ListSubheader');
  const classConditions = mapApiTranslations(req3, 'ListSubheader');
