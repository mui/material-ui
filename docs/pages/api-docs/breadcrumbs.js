...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'Breadcrumbs');
  const classDescriptions = mapApiTranslations(req2, 'Breadcrumbs');
  const classConditions = mapApiTranslations(req3, 'Breadcrumbs');
