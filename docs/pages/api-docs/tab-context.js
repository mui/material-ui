...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'TabContext');
  const classDescriptions = mapApiTranslations(req2, 'TabContext');
  const classConditions = mapApiTranslations(req3, 'TabContext');
