...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'TextareaAutosize');
  const classDescriptions = mapApiTranslations(req2, 'TextareaAutosize');
  const classConditions = mapApiTranslations(req3, 'TextareaAutosize');
