...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'TimelineDot');
  const classDescriptions = mapApiTranslations(req2, 'TimelineDot');
  const classConditions = mapApiTranslations(req3, 'TimelineDot');
