...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'ButtonGroup');
  const classDescriptions = mapApiTranslations(req2, 'ButtonGroup');
  const classConditions = mapApiTranslations(req3, 'ButtonGroup');
