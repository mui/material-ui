...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'DialogActions');
  const classDescriptions = mapApiTranslations(req2, 'DialogActions');
  const classConditions = mapApiTranslations(req3, 'DialogActions');
