...
const pageFilename = 'api-docs/dialog-actions';
const requireDemo = require.context('docs/src/pages/api-docs/dialog-actions', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/api-docs/dialog-actions',
  false,
  /\.(js|md|tsx)$/,
);
