...
const pageFilename = 'api-docs/input-base';
const requireDemo = require.context('docs/src/pages/api-docs/input-base', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/api-docs/input-base',
  false,
  /\.(js|md|tsx)$/,
);
