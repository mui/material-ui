...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'CardMedia');
  const classDescriptions = mapApiTranslations(req2, 'CardMedia');
  const classConditions = mapApiTranslations(req3, 'CardMedia');
