...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'Hidden');
  const classDescriptions = mapApiTranslations(req2, 'Hidden');
  const classConditions = mapApiTranslations(req3, 'Hidden');
