...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'SpeedDialIcon');
  const classDescriptions = mapApiTranslations(req2, 'SpeedDialIcon');
  const classConditions = mapApiTranslations(req3, 'SpeedDialIcon');
