...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'RadioGroup');
  const classDescriptions = mapApiTranslations(req2, 'RadioGroup');
  const classConditions = mapApiTranslations(req3, 'RadioGroup');
