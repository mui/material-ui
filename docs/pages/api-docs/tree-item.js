...
const pageFilename = 'api-docs/tree-item';
const requireDemo = require.context('docs/src/pages/api-docs/tree-item', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/api-docs/tree-item',
  false,
  /\.(js|md|tsx)$/,
);
