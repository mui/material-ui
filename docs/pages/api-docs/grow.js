...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'Grow');
  const classDescriptions = mapApiTranslations(req2, 'Grow');
  const classConditions = mapApiTranslations(req3, 'Grow');
