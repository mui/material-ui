...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'ListItemIcon');
  const classDescriptions = mapApiTranslations(req2, 'ListItemIcon');
  const classConditions = mapApiTranslations(req3, 'ListItemIcon');
