...
const pageFilename = 'api-docs/list-item-icon';
const requireDemo = require.context('docs/src/pages/api-docs/list-item-icon', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/api-docs/list-item-icon',
  false,
  /\.(js|md|tsx)$/,
);
