...
| <span class="prop-name required">position<abbr title="required">*</abbr></span> | <span class="prop-type">'end'<br>&#124;&nbsp;'start'</span> |  | The position this adornment should appear relative to the `Input`. |
