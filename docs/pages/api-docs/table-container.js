...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'TableContainer');
  const classDescriptions = mapApiTranslations(req2, 'TableContainer');
  const classConditions = mapApiTranslations(req3, 'TableContainer');
