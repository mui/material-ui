...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'Pagination');
  const classDescriptions = mapApiTranslations(req2, 'Pagination');
  const classConditions = mapApiTranslations(req3, 'Pagination');
