...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'ToggleButtonGroup');
  const classDescriptions = mapApiTranslations(req2, 'ToggleButtonGroup');
  const classConditions = mapApiTranslations(req3, 'ToggleButtonGroup');
