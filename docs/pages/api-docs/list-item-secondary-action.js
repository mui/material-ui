...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'ListItemSecondaryAction');
  const classDescriptions = mapApiTranslations(req2, 'ListItemSecondaryAction');
  const classConditions = mapApiTranslations(req3, 'ListItemSecondaryAction');
