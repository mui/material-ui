...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'Typography');
  const classDescriptions = mapApiTranslations(req2, 'Typography');
  const classConditions = mapApiTranslations(req3, 'Typography');
