...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'ListItemText');
  const classDescriptions = mapApiTranslations(req2, 'ListItemText');
  const classConditions = mapApiTranslations(req3, 'ListItemText');
