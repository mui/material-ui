...
const pageFilename = 'api-docs/tooltip';
const requireDemo = require.context('docs/src/pages/api-docs/tooltip', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/api-docs/tooltip',
  false,
  /\.(js|md|tsx)$/,
);
