...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'SvgIcon');
  const classDescriptions = mapApiTranslations(req2, 'SvgIcon');
  const classConditions = mapApiTranslations(req3, 'SvgIcon');
