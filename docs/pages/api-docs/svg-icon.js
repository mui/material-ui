...
const pageFilename = 'api-docs/svg-icon';
const requireDemo = require.context('docs/src/pages/api-docs/svg-icon', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/api-docs/svg-icon',
  false,
  /\.(js|md|tsx)$/,
);
