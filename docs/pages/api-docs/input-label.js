...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'InputLabel');
  const classDescriptions = mapApiTranslations(req2, 'InputLabel');
  const classConditions = mapApiTranslations(req3, 'InputLabel');
