...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'Badge');
  const classDescriptions = mapApiTranslations(req2, 'Badge');
  const classConditions = mapApiTranslations(req3, 'Badge');
