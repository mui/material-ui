...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'LoadingButton');
  const classDescriptions = mapApiTranslations(req2, 'LoadingButton');
  const classConditions = mapApiTranslations(req3, 'LoadingButton');
