...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'TabScrollButton');
  const classDescriptions = mapApiTranslations(req2, 'TabScrollButton');
  const classConditions = mapApiTranslations(req3, 'TabScrollButton');
