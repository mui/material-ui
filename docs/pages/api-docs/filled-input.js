...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'FilledInput');
  const classDescriptions = mapApiTranslations(req2, 'FilledInput');
  const classConditions = mapApiTranslations(req3, 'FilledInput');
