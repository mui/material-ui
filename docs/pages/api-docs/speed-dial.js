...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'SpeedDial');
  const classDescriptions = mapApiTranslations(req2, 'SpeedDial');
  const classConditions = mapApiTranslations(req3, 'SpeedDial');
