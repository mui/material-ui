...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'CardActions');
  const classDescriptions = mapApiTranslations(req2, 'CardActions');
  const classConditions = mapApiTranslations(req3, 'CardActions');
