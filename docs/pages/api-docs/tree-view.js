...
const pageFilename = 'api-docs/tree-view';
const requireDemo = require.context('docs/src/pages/api-docs/tree-view', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/api-docs/tree-view',
  false,
  /\.(js|md|tsx)$/,
);
