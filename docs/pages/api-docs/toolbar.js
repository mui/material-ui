...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'Toolbar');
  const classDescriptions = mapApiTranslations(req2, 'Toolbar');
  const classConditions = mapApiTranslations(req3, 'Toolbar');
