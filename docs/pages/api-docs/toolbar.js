...
const pageFilename = 'api-docs/toolbar';
const requireDemo = require.context('docs/src/pages/api-docs/toolbar', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/api-docs/toolbar',
  false,
  /\.(js|md|tsx)$/,
);
