...
| <span class="prop-name">parentRef</span> | <span class="prop-type">object</span> |  | If defined, then element slides in from the edge of the parentRef element, else it slides from the edge of the screen. |
