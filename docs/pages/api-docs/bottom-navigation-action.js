...
const pageFilename = 'api-docs/bottom-navigation-action';
const requireDemo = require.context(
  'docs/src/pages/api-docs/bottom-navigation-action',
  false,
  /\.(js|tsx)$/,
);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/api-docs/bottom-navigation-action',
  false,
  /\.(js|md|tsx)$/,
);
