...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'BottomNavigationAction');
  const classDescriptions = mapApiTranslations(req2, 'BottomNavigationAction');
  const classConditions = mapApiTranslations(req3, 'BottomNavigationAction');
