...
const pageFilename = 'api-docs/table-footer';
const requireDemo = require.context('docs/src/pages/api-docs/table-footer', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/api-docs/table-footer',
  false,
  /\.(js|md|tsx)$/,
);
