...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'MenuList');
  const classDescriptions = mapApiTranslations(req2, 'MenuList');
  const classConditions = mapApiTranslations(req3, 'MenuList');
