...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'Menu');
  const classDescriptions = mapApiTranslations(req2, 'Menu');
  const classConditions = mapApiTranslations(req3, 'Menu');
