...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'TableSortLabel');
  const classDescriptions = mapApiTranslations(req2, 'TableSortLabel');
  const classConditions = mapApiTranslations(req3, 'TableSortLabel');
