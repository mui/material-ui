...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'FormHelperText');
  const classDescriptions = mapApiTranslations(req2, 'FormHelperText');
  const classConditions = mapApiTranslations(req3, 'FormHelperText');
