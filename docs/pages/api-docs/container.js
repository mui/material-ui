...
const pageFilename = 'api-docs/container';
const requireDemo = require.context('docs/src/pages/api-docs/container', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/api-docs/container',
  false,
  /\.(js|md|tsx)$/,
);
