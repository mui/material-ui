...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'ClickAwayListener');
  const classDescriptions = mapApiTranslations(req2, 'ClickAwayListener');
  const classConditions = mapApiTranslations(req3, 'ClickAwayListener');
