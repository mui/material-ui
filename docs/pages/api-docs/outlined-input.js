...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'OutlinedInput');
  const classDescriptions = mapApiTranslations(req2, 'OutlinedInput');
  const classConditions = mapApiTranslations(req3, 'OutlinedInput');
