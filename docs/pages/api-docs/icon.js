...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'Icon');
  const classDescriptions = mapApiTranslations(req2, 'Icon');
  const classConditions = mapApiTranslations(req3, 'Icon');
