...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'TabPanel');
  const classDescriptions = mapApiTranslations(req2, 'TabPanel');
  const classConditions = mapApiTranslations(req3, 'TabPanel');
