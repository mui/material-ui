...
const pageFilename = 'api-docs/menu-item';
const requireDemo = require.context('docs/src/pages/api-docs/menu-item', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/api-docs/menu-item',
  false,
  /\.(js|md|tsx)$/,
);
