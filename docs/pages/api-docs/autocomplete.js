...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'Autocomplete');
  const classDescriptions = mapApiTranslations(req2, 'Autocomplete');
  const classConditions = mapApiTranslations(req3, 'Autocomplete');
