...
const pageFilename = 'api-docs/autocomplete';
const requireDemo = require.context('docs/src/pages/api-docs/autocomplete', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/api-docs/autocomplete',
  false,
  /\.(js|md|tsx)$/,
);
