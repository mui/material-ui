...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'CardHeader');
  const classDescriptions = mapApiTranslations(req2, 'CardHeader');
  const classConditions = mapApiTranslations(req3, 'CardHeader');
