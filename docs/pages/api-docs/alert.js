...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'Alert');
  const classDescriptions = mapApiTranslations(req2, 'Alert');
  const classConditions = mapApiTranslations(req3, 'Alert');
