...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'SliderStyled');
  const classDescriptions = mapApiTranslations(req2, 'SliderStyled');
  const classConditions = mapApiTranslations(req3, 'SliderStyled');
