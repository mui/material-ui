...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'DialogContent');
  const classDescriptions = mapApiTranslations(req2, 'DialogContent');
  const classConditions = mapApiTranslations(req3, 'DialogContent');
