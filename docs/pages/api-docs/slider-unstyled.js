...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'SliderUnstyled');
  const classDescriptions = mapApiTranslations(req2, 'SliderUnstyled');
  const classConditions = mapApiTranslations(req3, 'SliderUnstyled');
