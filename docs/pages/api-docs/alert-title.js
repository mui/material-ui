...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'AlertTitle');
  const classDescriptions = mapApiTranslations(req2, 'AlertTitle');
  const classConditions = mapApiTranslations(req3, 'AlertTitle');
