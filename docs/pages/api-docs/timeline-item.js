...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'TimelineItem');
  const classDescriptions = mapApiTranslations(req2, 'TimelineItem');
  const classConditions = mapApiTranslations(req3, 'TimelineItem');
