...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'TableRow');
  const classDescriptions = mapApiTranslations(req2, 'TableRow');
  const classConditions = mapApiTranslations(req3, 'TableRow');
