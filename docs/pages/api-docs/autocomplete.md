...
| <span class="prop-name">disableClearable</span> | <span class="prop-type">any</span> | <span class="prop-default">false</span> | If `true`, the input can't be cleared. |
...
| <span class="prop-name">freeSolo</span> | <span class="prop-type">any</span> | <span class="prop-default">false</span> | If `true`, the Autocomplete is free solo, meaning that the user input is not bound to provided options. |
...
| <span class="prop-name">multiple</span> | <span class="prop-type">any</span> | <span class="prop-default">false</span> | If `true`, `value` must be an array and the menu will support multiple selections. |
