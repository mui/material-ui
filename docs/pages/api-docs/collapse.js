...
const pageFilename = 'api-docs/collapse';
const requireDemo = require.context('docs/src/pages/api-docs/collapse', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/api-docs/collapse',
  false,
  /\.(js|md|tsx)$/,
);
