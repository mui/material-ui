...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'Button');
  const classDescriptions = mapApiTranslations(req2, 'Button');
  const classConditions = mapApiTranslations(req3, 'Button');
