...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'ImageList');
  const classDescriptions = mapApiTranslations(req2, 'ImageList');
  const classConditions = mapApiTranslations(req3, 'ImageList');
