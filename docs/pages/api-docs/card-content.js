...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'CardContent');
  const classDescriptions = mapApiTranslations(req2, 'CardContent');
  const classConditions = mapApiTranslations(req3, 'CardContent');
