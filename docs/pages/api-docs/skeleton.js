...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'Skeleton');
  const classDescriptions = mapApiTranslations(req2, 'Skeleton');
  const classConditions = mapApiTranslations(req3, 'Skeleton');
