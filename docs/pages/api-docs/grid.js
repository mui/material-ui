...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'Grid');
  const classDescriptions = mapApiTranslations(req2, 'Grid');
  const classConditions = mapApiTranslations(req3, 'Grid');
