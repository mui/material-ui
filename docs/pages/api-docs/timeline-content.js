...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'TimelineContent');
  const classDescriptions = mapApiTranslations(req2, 'TimelineContent');
  const classConditions = mapApiTranslations(req3, 'TimelineContent');
