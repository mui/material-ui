...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'Checkbox');
  const classDescriptions = mapApiTranslations(req2, 'Checkbox');
  const classConditions = mapApiTranslations(req3, 'Checkbox');
