...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'Select');
  const classDescriptions = mapApiTranslations(req2, 'Select');
  const classConditions = mapApiTranslations(req3, 'Select');
