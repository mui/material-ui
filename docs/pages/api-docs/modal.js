...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'Modal');
  const classDescriptions = mapApiTranslations(req2, 'Modal');
  const classConditions = mapApiTranslations(req3, 'Modal');
