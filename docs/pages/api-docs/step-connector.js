...
const pageFilename = 'api-docs/step-connector';
const requireDemo = require.context('docs/src/pages/api-docs/step-connector', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/api-docs/step-connector',
  false,
  /\.(js|md|tsx)$/,
);
