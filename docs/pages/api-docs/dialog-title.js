...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'DialogTitle');
  const classDescriptions = mapApiTranslations(req2, 'DialogTitle');
  const classConditions = mapApiTranslations(req3, 'DialogTitle');
