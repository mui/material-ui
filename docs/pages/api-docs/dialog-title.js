...
const pageFilename = 'api-docs/dialog-title';
const requireDemo = require.context('docs/src/pages/api-docs/dialog-title', false, /\.(js|tsx)$/);
const requireRaw = require.context(
  '!raw-loader!../../src/pages/api-docs/dialog-title',
  false,
  /\.(js|md|tsx)$/,
);
