...
export async function getStaticProps() {
  ...
  const propDescriptions = mapApiTranslations(req, 'CssBaseline');
  const classDescriptions = mapApiTranslations(req2, 'CssBaseline');
  const classConditions = mapApiTranslations(req3, 'CssBaseline');
