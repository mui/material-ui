...
Existem dois componentes principais disponíveis para realizar navegações. O mais comum é o [`Link`](/material/components/links/) como seu nome pode sugerir. Ele renderiza um elemento `<a>` nativo e aplica o `href` como um atributo.
