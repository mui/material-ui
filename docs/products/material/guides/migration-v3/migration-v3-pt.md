...
- [Portal] O elemento filho precisa ser capaz de lidar com ref, quando a propriedade `disablePortal` é usada. The [composition guide](/material/guides/composition/#caveat-with-refs) explains the migration strategy.

### Slide

- [Slide] O elemento filho precisa ser capaz de lidar com ref. The [composition guide](/material/guides/composition/#caveat-with-refs) explains the migration strategy.
...
- [Tooltip] O elemento filho precisa ser capaz de lidar com ref. The [composition guide](/material/guides/composition/#caveat-with-refs) explains the migration strategy.
