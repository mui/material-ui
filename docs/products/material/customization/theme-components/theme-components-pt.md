...
To override a lab component's styles with TypeScript, check [this section of the documentation](/material/components/about-the-lab/#typescript).
...
To override lab component styles with TypeScript, check [this page](/material/components/about-the-lab/#typescript).
