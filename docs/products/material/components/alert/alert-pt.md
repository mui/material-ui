...
Você pode utilizar um [componente de transição](/material/components/transitions/) como um `Collapse` para realizar uma transição na exibição do alerta.
...
Você pode usar o componente Snackbar para [exibir um toast](/material/components/snackbars/#customized-snackbars) com o componente Alert.
