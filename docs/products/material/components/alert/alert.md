...
You can use a [transition component](/material/components/transitions/) such as `Collapse` to transition the appearance of the alert.
...
You can use the Snackbar to [display a toast](/material/components/snackbars/#customized-snackbars) with the Alert.
