...
[the theme customization section](/material/customization/typography/).
...
Hopefully, you might be able to take advantage of the [`typography`](/material/customization/default-theme/?expand-path=$.typography) keys of the theme.
...
- You can change the mapping [globally using the theme](/material/customization/theme-components/#default-props):
...
- **Font size**. Use [relative units (rem)](/material/customization/typography/#font-size) to accommodate the user's settings.
