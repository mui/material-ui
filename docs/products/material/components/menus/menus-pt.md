...
Devido ao componente `Menu` usar o componente `Popover` para se posicionar, você pode usar as mesmas [propriedades de posicionamento](/material/components/popover/#anchor-playground) para posicioná-lo. For instance, you can display the menu on top of the anchor:
