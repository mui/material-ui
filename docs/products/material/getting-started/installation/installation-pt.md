...
MUI foi desenvolvida com base na fonte [Roboto](https://fonts.google.com/specimen/Roboto). Portanto, certifique-se de seguir [estas instruções](/material/components/typography/#general) para carregá-la. For instance, via Google Web Fonts:
...
Para usar o componente de fonte `Icon`, você deve primeiramente adiciona a fonte de [ícones Material](https://fonts.google.com/icons). Aqui estão [algumas instruções](/material/components/icons/#font-icons) de como fazer isso. Como alternativa, carregue através do Google Web Fonts:
...
Para usar os ícones SVG pré-definidos do Material, como os encontrados na [demonstração de ícones](/material/components/icons/), você deve primeiro instalar o pacote [@mui/icons-material](https://www.npmjs.com/package/@mui/icons-material):
