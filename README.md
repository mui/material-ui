...
Material UI's core functionality is extended by [MUI X](https://github.com/mui/mui-x), a suite of complex components for advanced use cases. [Toolpad](https://github.com/mui/toolpad) integrates various Material UI components and can be good starting point for building dashboards and internal tools.
