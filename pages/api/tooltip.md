...
| <span class="prop-name">interactive</span> | <span class="prop-type">bool</span> |   | Makes a tooltip interactive, i.e. will not close when the user hovers over the tooltip before the `leaveDelay` is expired. |
