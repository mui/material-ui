...
| <span class="prop-name">defaultValue</span> | <span class="prop-type">union:&nbsp;string&nbsp;&#124;<br>&nbsp;number&nbsp;&#124;<br>&nbsp;bool<br></span> |   | The default input value of an uncontrolled RadioGroup. Required when `RadioGroup` is uncontrolled. |
