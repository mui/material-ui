...
| <span class="prop-name">variant</span> | <span class="prop-type">enum:&nbsp;'indeterminate'&nbsp;&#124;<br>&nbsp;'determinate'&nbsp;&#124;<br>&nbsp;'determinate-spin'<br> | <span class="prop-default">'indeterminate'</span> | The variant of progress indicator. Use indeterminate when there is no progress value. |
