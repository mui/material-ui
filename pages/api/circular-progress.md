...
| <span class="prop-name">disableShrinkAnimation</span> | <span class="prop-type">bool</span> | <span class="prop-default">false</span> | If `true`, the shrink animation is disabled. This only works if variant is `indeterminate` |
...
| <span class="prop-name">disableShrinkAnimation</span> | Styles applied to the `circle` svg path if `disableShrinkAnimation={true}`.
