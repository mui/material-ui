...
| <span class="prop-name">disableFocusRipple</span> | <span class="prop-type">deprecated(
  PropTypes.bool,
  'Focus ripple will be removed because it does not follow Material design.',
) | <span class="prop-default">true</span> | If `true`, the  keyboard focus ripple will be disabled. `disableRipple` must also be true. |
