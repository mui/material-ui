...
|:-----|:-----|:--------|:------------|
| <span class="prop-name">children</span> | <span class="prop-type">node</span> |  | The wrapped node. |
| <span class="prop-name required">getTargetEl&nbsp;*</span> | <span class="prop-type">func</span> |  | A function that must return the `Element` (once it is mounted) that should not be considered in click-away. |
