...
| ~~<span class="prop-name">scrollable</span>~~ | <span class="prop-type">bool</span> |   | *Deprecated*. Instead use the `variant="scrollable"` property.<br><br>If `true` it invokes scrolling properties and allow for horizontally scrolling (or swiping) of the tab bar. |
