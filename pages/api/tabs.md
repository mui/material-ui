...
| <span class="prop-name">scrollButtonLabel</span> | <span class="prop-type">func</span> | <span class="prop-default">position =>  position === 'start' ? 'Scroll to the start' : 'Scroll to the end'</span> | A function that returns the aria-label attribute to apply on the scroll buttons.<br><br>**Signature:**<br>`function(position: string) => void`<br>*position:* The position of the scroll button (start or end). |
