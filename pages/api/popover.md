...
| <span style="color: #31a148">anchorOrigin *</span> | signature | {  vertical: 'top',  horizontal: 'left',} | This is the point on the anchor where the popover's `anchorEl` will attach to. This is not used when the anchorReference is 'anchorPosition'.<br>Options: vertical: [top, center, bottom]; horizontal: [left, center, right]. |
...
| <span style="color: #31a148">marginThreshold *</span> | number | 16 | Specifies how close to the edge of the window the popover can appear. |
