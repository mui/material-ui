...
| <span class="prop-name">disablePointerEvents</span> | <span class="prop-type">bool</span> | <span class="prop-default">false</span> | Disable pointer events on the root. This allows for the text in the adornment to focus the input on click. |
...
| <span class="prop-name">disabledPointerEvents</span> | Styles applied to the root element if `disablePointerEvents=true`
