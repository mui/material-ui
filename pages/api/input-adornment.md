...
| <span class="prop-name">disablePointerEvents</span> | <span class="prop-type">bool</span> |   | Disable pointer events on the root. This allows for the text in the adornment to focus the input on click. |
