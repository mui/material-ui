...
| <span class="prop-name">inputComponent</span> | <span class="prop-type">componentPropType</span> |   | The component used for the native input. Either a string to use a DOM element or a component. |
