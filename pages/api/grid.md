...
| <span class="prop-name">container</span>    | <span class="prop-type">bool</span>                                                                                                                        | <span class="prop-default">false</span>        | If `true`, the component will have the flex _container_ behavior. You should be wrapping _items_ with a _container_.                    |
...
| <span class="prop-name">item</span>         | <span class="prop-type">bool</span>                                                                                                                        | <span class="prop-default">false</span>        | If `true`, the component will have the flex _item_ behavior. You should be wrapping _items_ with a _container_.                         |
