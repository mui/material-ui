...
| <span class="prop-name">spacing</span> | <span class="prop-type">enum:&nbsp;0, 1, 2, 3, 4, 5, 6, 7, 8<br></span> | <span class="prop-default">0</span> | Defines the space between the type `item` component. It can only be used on a type `container` component. |
