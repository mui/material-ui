...
`,
        ...
        'pages/demos/progress/CircularDeterminateSpin.js': {
          js: require('docs/src/pages/demos/progress/CircularDeterminateSpin').default,
          raw: preval`
module.exports = require('fs')
  .readFileSync(require.resolve('docs/src/pages/demos/progress/CircularDeterminateSpin'), 'utf8')
`,
        },
