...
function Page() {
  return (
    <MarkdownDocs
      markdown={markdown}
      demos={{
        'pages/lab/speed-dial/SpeedDial.js': {
          js: require('docs/src/pages/lab/speed-dial/SpeedDial').default,
          raw: preval`
module.exports = require('fs')
  .readFileSync(require.resolve('docs/src/pages/lab/speed-dial/SpeedDial'), 'utf8')
`,
        },
