 ...
 *
 * Wrapped in React.memo to prevent unnecessary re-renders when carousel state hasn't changed.
 */
const CarouselIndicators = React.memo(
  React.forwardRef<HTMLDivElement, CarouselIndicatorsProps>(function CarouselIndicators(inProps, ref) {
