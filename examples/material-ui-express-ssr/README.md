...
```bash
curl https://codeload.github.com/mui/material-ui/tar.gz/v9.x | tar -xz --strip=2  material-ui-9.x/examples/material-ui-express-ssr
...
[![Edit on StackBlitz](https://developer.stackblitz.com/img/open_in_stackblitz.svg)](https://stackblitz.com/github/mui/material-ui/tree/v9.x/examples/material-ui-express-ssr)

[![Edit on CodeSandbox](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/p/sandbox/github/mui/material-ui/tree/v9.x/examples/material-ui-express-ssr)
