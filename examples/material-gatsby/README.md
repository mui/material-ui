...
It includes `@mui/material` and its peer dependencies, including [Emotion library](https://emotion.sh/docs/introduction) which is default style engine in Material UI v5.
