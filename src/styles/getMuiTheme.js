...
export default function getMuiTheme(muiTheme, ...more) {
  ...
  muiTheme = merge({
    ...
    checkbox: {
      ...
      checkedColor: palette.accent4Color,
      requiredColor: palette.accent4Color,
    ...
    toggle: {
      thumbOnColor: palette.accent4Color,
      thumbOffColor: palette.accent2Color,
      thumbDisabledColor: palette.borderColor,
      thumbRequiredColor: palette.accent4Color,
      trackOnColor: fade(palette.accent4Color, 0.5),
      trackOffColor: palette.accent5Color,
      trackDisabledColor: palette.accent5Color,
      labelColor: palette.textColor,
      labelDisabledColor: palette.disabledColor,
      trackRequiredColor: fade(palette.accent4Color, 0.5),
    },
    toolbar: {
      color: fade(palette.textColor, 0.54),
