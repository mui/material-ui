...
declare class StyledComponent<OP, C: ComponentType<OP>, P: OP & { classes?: Object }> extends Component<P> {
...
function withStyles<OP, P: OP & { classes?: Object }, C: ComponentType<OP>>(
  stylesOrCreator: Object,
  options?: Object = {},
): (c: C) => Class<StyledComponent<OP, C, P>> {
  return BaseComponent => {
    ...
    class Style extends Component<Object, $FlowFixMeState> {
      props: Object;
