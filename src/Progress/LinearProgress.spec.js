...
describe('<LinearProgress />', () => {
  ...
  it('should set width of bar1 and bar2 on buffer mode', () => {
    ...
    assert.strictEqual(wrapper.hasClass(classes.root), true, 'should have the root class');
    assert.strictEqual(wrapper.childAt(1).props().style.width, '85%', 'should have width set');
    assert.strictEqual(wrapper.childAt(2).props().style.width, '77%', 'should have width set');
  });
