...
describe('<Button>', () => {
  ...
  it('should render with the button class but no others', () => {
    const wrapper = shallow(
      <Button>Hello World</Button>
    );
    assert.strictEqual(wrapper.hasClass(classes.button), true, 'should have the button class');
  ...
  it('should render the custom className and the button class', () => {
    const wrapper = shallow(
