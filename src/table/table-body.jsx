...
const TableBody = React.createClass({
  ...
  componentWillReceiveProps (nextProps, nextContext) {
    ...
    if (this.props.allRowsSelected && !nextProps.allRowsSelected) {
      console.log('Deseleciona', this.state.selectedRows);
      ...
      console.log('Seleciona', this.state.selectedRows);
  ...
  _processRowSelection(e, rowNumber) {
    ...
    let selecteds = this._flattenRanges(selectedRows);
    console.log('_processRowSelection', selecteds, selectedRows);
    if (this.props.onRowSelection) this.props.onRowSelection(selecteds);
  },
