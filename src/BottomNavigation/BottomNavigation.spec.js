...
describe('<BottomNavigation>', () => {
  ...
  it('should render a div', () => {
    const wrapper = shallow(
      <BottomNavigation onChangeIndex={() => {}}><BottomNavigationButton icon={icon} /></BottomNavigation>
    );
  ...
  it('should render with the user and root classes', () => {
    const wrapper = shallow(
      <BottomNavigation className="woof" onChangeIndex={() => {}}>
  ...
  it('should pass selected prop to children', () => {
    const wrapper = shallow(
      <BottomNavigation className="woof" selectedIndex={1} onChangeIndex={() => {}}>
        <BottomNavigationButton icon={icon} />
        <BottomNavigationButton icon={icon} />
      </BottomNavigation>
    );
  ...
  it('should pass selected prop to children', () => {
    ...
    const wrapper = shallow(
      <BottomNavigation className="woof" selectedIndex={0} onChangeIndex={handleChangeIndex}>
        <BottomNavigationButton icon={icon} />
        <BottomNavigationButton icon={icon} />
      </BottomNavigation>
    );
